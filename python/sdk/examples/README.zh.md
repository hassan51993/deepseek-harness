...
مع مرفق [`@deepseek-ai/dsh-sdk-minimal` تركيب حزمة](../../../packages/bundle/sdk-minimal/README.zh.md) هو هذا نمط كامل كما صريح Cordis إعداد شجرة. هو فقط كشف:
...
آخر رؤية [Python SDK تعليم مسار](../../../docs/user/guide/python-sdk.zh.md) و [SDK مشاركة اعتبار](../README.zh.md).
