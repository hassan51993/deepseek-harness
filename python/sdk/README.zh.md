...
آخر رؤية [Python تعليم مسار](../../docs/user/guide/python-sdk.zh.md) ،[يمكن تشغيل عرض مثال](examples/README.zh.md) و [وقت التشغيل wheel حزمة مشاركة اعتبار](../sdk-runtime/README.zh.md).
