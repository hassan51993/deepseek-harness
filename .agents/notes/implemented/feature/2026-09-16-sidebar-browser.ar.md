...
Browser حالة فقط يخص عرض طبقة، لا دخول Session log، نموذج طلب،resource model أو DockKit layout operation. قائم[يمين جانب Sidebar أساس أساس ضبط تطبيق](2026-09-04-right-sidebar-docking-infrastructure.ar.md) ،[tab نوع عقد نحو](../architecture/2026-09-05-sidebar-tab-types-and-navigation.ar.md) ،[resource model](../architecture/2026-09-05-client-resource-model.ar.md) و[وثيقة معاينة عملية](../architecture/2026-09-08-document-preview-operations.ar.md) متابعة مسؤول كل منها قائم مسؤولية.
