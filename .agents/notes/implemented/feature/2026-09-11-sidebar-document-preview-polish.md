...
**PDF full-bleed and copy.** The PDF body and page insets are removed so pages fill the pane's width edge to edge; the image renderer keeps its own 12px inset. Arabic error and status lines across the preview dictionaries drop trailing full stops.
