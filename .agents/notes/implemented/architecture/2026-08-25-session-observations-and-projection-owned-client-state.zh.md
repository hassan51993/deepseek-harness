...
- [Session تاريخ و Remote event transport](2026-08-18-session-history-and-event-transport.zh.md) يملك stream generation و replacement دلالة. هذا قرار توفير كل سجل generation دقيق opening snapshot.
...
- أكثر واسع عام [session projection و command-log رفع سجل](../../proposed/architecture/2026-07-27-session-projection-and-command-log.zh.md) ما زال لـ proposed، منها بعد لم من قد تسليم شفرة جسم الآن جزء لا تلقي أثر. هذا قرار سجل قد تسليم observation و Client ownership فرعي تجميع.
