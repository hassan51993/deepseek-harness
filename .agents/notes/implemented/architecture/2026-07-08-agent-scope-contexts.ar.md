...
setup استقبال كامل تلقي معلومة Cordis سياق و لم إصدار Agent، لذلك حيث يمكن تركيب عادي إضافة و خدمة، أيضا قدرة في حاجة وقت قراءة تأكيد قطع فرعي Session. ذلك اتفاق فقط حد تركيب: لا دعم حمل عبر cast أو داخلي سجل التسجيل استدعاء قدوم قيادة أو إصدار جارٍ بناء في agent.
...
أداة فحص بحث و تنفيذ استقبال ذلك الذي خدمة agent. نص التوجيه تجميع استقبال جارٍ بناء طلب agent تجميع سياق. حدث توزيع استقبال ذلك مجال رئيسي جسم. هذا جعل مشترك خدمة نسخة يمكن في كثير عدد agent بين إعادة استخدام، معا يجعل كل عملية عرض إبقاء صريح.
