...
- **تركيب حزمة نقل تمرير صيغة تلقائي تطبيق**: فقط لديه مباشر صف في `dsh.profile.bundles` في بند عندئذ مساهمة طبقة؛ تفكير إعادة تصدير آخر عدد تركيب حزمة patch عنصر تركيب حزمة، يجب في ذاتي ذات patch ملف في صريح إتمام.
