...
> نطاق:`dsh web` مثل أي تركيب (cordis.yml + cordis قبل boot صنف + إعداد مصدر) ، و web نقل مثل أي عبر حزمة قسم طبقة (شبكة صلة / تحميل جسم / ربط / رسم / تطوير مدة إعادة تحميل). متصفح جانب تركيب تحميل سلسلة عودة [client إضافة تركيب تحميل note](2026-07-23-client-plugin-loading-model.ar.md) كل، هذا تركيب فقط هو هو توفير إعطاء جهة.
