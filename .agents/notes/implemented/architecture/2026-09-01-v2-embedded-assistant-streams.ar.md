...
[V3 مواصفة معلومة غلاف قرار](2026-09-06-v3-canonical-session-envelopes.ar.md) مسؤول حالي استبدال مفتاح و طلب رأس وصل قبول قاعدة. هو إبقاء هذا نص تضمين دخول صيغة stream، محاولة تجربة تسوية و تجميد ربط v1-to-v2 تحويل.
...
Generation اختيار و إصدار التزام دوران[قد إصدار Session ترحيل قرار](2026-08-31-released-session-format-migrations.ar.md): مصدر مسار، بايت و inode إبقاء ثابت، فقط إصدار نهائي أداة اسم إصدار successor؛ إبقاء predecessor لا توفير fallback أو downgrade دعم حمل.
