...
هذا عدد فعلي تحقق حزمة معا يتضمن بروتوكول و runtime تنفيذ:`PythonPtcRuntime`(إضافة افتراضي تصدير) ،`python3 -I` عملية فرعية مسار و Python جانب JSON codec كل في `@deepseek-ai/dsh-experimental-ptc-runtime-python` في. بروتوكول بناء قيام في[يمكن نقل غرس معرف رمز seam](../../archived/architecture/2026-07-31-code-runtime-portable-identifier-seam.md) لـ فوق.
...
بديل قيمة: حزمة اسم يمثل Python runtime بيت عائلة، بينما `src/index.ts` تصدير كامل `PythonPtcRuntime` تنفيذ، بروتوكول vocabulary فقط هو حزمة جدول وجه واحد جزء.mirror e2e سوف مقارنة مقارنة اثنان جانب حقل اسم و لا بد ملء/اختياري حالة، لكن لا مقارنة مقارنة حقل نوع؛ عبر TypeScript و Python مقارنة مقارنة نوع إعلان لا يوجد آلة آلة انتظار قيمة شيء، لذلك مراجعة و runtime حقيقي عملية فرعية طقم عنصر متابعة مسؤول هذا بند فحص.
