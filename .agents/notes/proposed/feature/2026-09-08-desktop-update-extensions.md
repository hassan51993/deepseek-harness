...
English | [العربية](2026-09-08-desktop-update-extensions.ar.md)
...
The candidate setting is automatic installation, potentially enabled by default only after product approval and measured platform behavior. Candidate Arabic helper text is “إغلاق بعد ما زال سوف تلميح تحديث، يحتاج يد حركة ترقية.” If next-launch installation is not acceptable, evaluate a download-only setting and retain explicit installation confirmation.
