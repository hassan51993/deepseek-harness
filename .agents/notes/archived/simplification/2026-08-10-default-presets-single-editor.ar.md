...
هذا قرار استلام ضيق preset أداة بيان، لا إزالة أداة حزمة و ذلك Python وقت التشغيل دعم حمل. مقارنة مبكر[مشترك بيان قرار](../feature/2026-07-31-even-out-shipped-tool-rosters.ar.md) متابعة شرح و surface غير متصل أداة لـ أي عودة preset تركيب كل؛ هذا سجل شرح تحرير جهاز مثال خارج.
