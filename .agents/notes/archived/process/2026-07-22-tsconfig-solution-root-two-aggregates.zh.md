...
- [ts-build-config Agent Note](2026-06-17-ts-build-config.zh.md) متابعة يملك tsc أولا سطر بناء خط الإنتاج (tsc مسؤول إخراج،tsdown مسؤول تحزيم،`.ts` شرح رمز إعداد دمج `rewriteRelativeImportExtensions`) ؛ ذلك أصل أولا «مفرد واحد أصل نوع فحص مشروع» شكل من هذا نص يحل محل.
