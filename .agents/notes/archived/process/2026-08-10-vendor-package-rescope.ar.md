...
تسعة عدد حزمة موحد واحد تعديل اسم دخول `@deepseek-ai` scope. دليل اسم، فوق تنقل رقم الإصدار، اعتماد range واحد قاعدة لا حركة، الذي بـ `vendor/README.md` بيان ما زال قراءة عمل واحد نسخة فوق تنقل لقطة. موجه إلى استخدام من خريطة جدول رؤية [docs/rescope.md](../../../../docs/rescope.ar.md).
