...
English | [العربية](2026-07-28-per-subsystem-cordis-surface-regions.ar.md)
...
- **Localized regions (generator emits Chinese too)** — deferred, same status as the i18n README's long-standing note for the remaining generated docs: teaching the generator ar output means translating source JSDoc, which is machinery this change does not need. English regions inside ar pages match the existing status quo of English JSDoc inside verbatim fences.
