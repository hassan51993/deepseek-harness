...
**يأخذ فارغ أبيض حالة و الأكثر قريب وقت تخزين دخول مرجعي persistence index.** مؤقت مؤقت، لأن تسليم JSONL provider أول سطر غير ممكن تغيير، حاجة زيادة حمل لديه ترتيب كتابة اشتراط ثاني نسخة حمل دائم عمل عنصر. مستودع خارج provider فقط لديه تعريف تحديث أصل فرعي صفة، إصدار و استعادة دلالة بعد عندئذ يمكن استخدام ذاتي ذات بحث جذب. أكثر واسع عام دقيق بحث جذب تصميم ما زال من[الأكثر بعد نشط حركة رفع سجل](../../proposed/architecture/2026-07-29-durable-last-activity-index.ar.md) مسؤول.
