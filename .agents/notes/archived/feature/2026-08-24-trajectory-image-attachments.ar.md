...
**إبقاء Trajectory ذاتي ذات `<img>` تصيير و تغذية إعطاء هو تحليل جيد URL.** هذا سوف تكرار `ui-attachment` قد يملك تحميل احتلال موضع، إعادة محاولة تحكم عنصر و مصباح صندوق، و و[أساس في slot مرفق عنصر كل حق](../architecture/2026-08-17-dynamic-client-render-and-attachment-ownership.ar.md) متبادل مقاومة لمس، هذا قرار قد رفض عبر إضافة مباشر import مكون.
