...
- [وسم تحويل أداة استدعاء تصيير معنى رسم ربط دمج نوع](../architecture/2026-07-02-tool-render-intent-union.zh.md) —— هذا بطاقة بـ `web` فرع توسيع `card` وسم مفردات جدول.
- [Web terminal card](2026-07-28-web-terminal-card.zh.md) —— يأخذ bash `terminal` تصيير معنى رسم حمل إلى متصفح أولا مثال؛[Web result card قبل طرف](2026-07-30-web-result-card-frontend.zh.md) هو هو إبرة مقابل هذا واحد فرع مقابل خطة.
