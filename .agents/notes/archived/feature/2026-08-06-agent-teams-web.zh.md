...
مستقر Web preset ما زال سوف في ذاته preset scope داخل تسجيل continuable Subagent control. قمة طبقة Agent Teams profile override لا يمكن استبدال هذه registration، لذلك هذا فعلي تحقق صفة composition ممكن معا كشف Team roster و legacy child control.Team-aware Web preset مؤقت مؤقت تنفيذ؛[Web profile README](../../../../packages/experimental/agent-team-web-profile/README.zh.md#known-limitations-and-deferred-work) مسؤول سجل حالي حد.
