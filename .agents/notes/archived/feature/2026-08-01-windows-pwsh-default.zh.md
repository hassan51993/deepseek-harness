...
pwsh GUI تصيير قد مع [pwsh UI عرض و bash مقابل متساو قرار](2026-08-05-pwsh-ui-bash-parity.zh.md) أولا سطر تسليم؛[pwsh أداة و bash مقابل متساو قرار](2026-08-02-pwsh-tool-bash-parity.zh.md) تسليم أداة جدول وجه. هذا قرار لا تغيير أي POSIX سلوك.
