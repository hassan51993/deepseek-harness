...
[pwsh أداة و bash مقابل متساو قرار](../../implemented/feature/2026-08-02-pwsh-tool-bash-parity.zh.md) يجعل `dsh-tool-pwsh` في تنفيذ،marker و خلفية مهمة فوق سلوك يمكن متبادل تبديل، لكن واضح دفع متأخر موجه إلى شخص صنف واحد نصف: إتمام pwsh قبل منصة استدعاء عرض لـ عام `console` محيط شريط بطاقة، بينما bash أداة إتمام استدعاء عرض لـ حمل تحليل خروج حالة pill terminal بطاقة. مسؤول حل قرار هذا نقص فتحة مسار خط رسم ([Windows افتراضي تعديل استخدام pwsh](../../implemented/feature/2026-08-01-windows-pwsh-default.zh.md)) يأخذ «pwsh TUI/GUI تصيير» صف لـ مرحلة مقطع 2، لكن TUI حزمة قد يتم إزالة، جعل Web جدول وجه يصبح هذا نقص فتحة وحيد أثر UI.
