...
English | [العربية](2026-08-27-web-at-mention-discovery-and-row-content.zh.md)
...
The zh composer placeholder says `ملف أو محادثة`, matching the `محادثة` section title the same menu already shows.
