...
- [افتراضي تركيب Note](2026-07-31-web-telemetry-default-mount.ar.md) هوية follow-up في «مجهول اسم مستخدم id» بند من هذا قرار إغلاق؛hostname/surface صيانة درجة و انفصال حساس قاعدة،usage-metrics track ما زال هو انتظار إنجاز.
