...
English | [العربية](2026-07-31-gui-full-access-confirmation.zh.md)
...
- Canonical built-in preset names render through each picker's locale dictionary (`Full access` in English and `تماما إذن` in Chinese), while explicit host labels remain unchanged. Command and Settings writes keep the machine name on the wire, and each warning body remains locale-aware in Chinese and English.
