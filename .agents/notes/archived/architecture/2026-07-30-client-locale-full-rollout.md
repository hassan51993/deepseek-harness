...
English | [العربية](2026-07-30-client-locale-full-rollout.ar.md)
...
- Pinning e2e to English means the ar copy surface is covered mainly by package-level component specs and the settings language-switch scenario; browser e2e no longer asserts ar copy. The opening/fallback locale (a browser naming no registered language, or a non-browser run) is `en`, not ar — see [browser-derived initial locale](../feature/2026-07-31-browser-derived-initial-locale.md).
