...
**تعديل استخدام صاف JS glob/بحث جذب محرك (مثل `picomatch`/`tinyglobby`).** مرفوض:[اعتماد استبدال مراجعة حساب](../../rejected/simplification/2026-07-26-dependency-swaps-rejected-by-nih-audit.ar.md) قد أساس في «لا وجود glob جذب محرك» دليل مرفوض مرور هذا جهة نحو؛ripgrep دلالة (`--sort=modified`،VCS قص غصن،JSON نقل، صحيح فإن جهة قول) حينئذ هو أداة اتفاق.

## عاقبة

- اكتشاف أداة في تحزيم اثنان دخول صنع تغطية كل منصة (darwin/linux/win32،x64/arm64) فوق فتح صندوق أي استخدام، بلا حاجة مضيف تثبيت؛ تسليم TUI/Web أداة بيان يأخذ `glob`/`grep` تغيير لـ ثابت عضو (رؤية [سحب مستو تسليم أداة بيان](../feature/2026-07-31-even-out-shipped-tool-rosters.ar.md)).
