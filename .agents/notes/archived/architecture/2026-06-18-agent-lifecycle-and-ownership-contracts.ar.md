...
- **في `cancel()` خارج آخر ضبط واحد فقط في توقف خطوة `abort()`**: الأكثر أول إصدار مرور، بعد بسبب بلا شخص استخدام بينما إزالة؛`cancel()` هو وحيد عام إيقاف أصل لغة (رؤية[عام إيقاف واجهة Agent Note](../simplification/2026-06-20-public-agent-stop-api.ar.md)).
