...
هذا قرار جزء يحل محل ثلاثة بند الآن سطر قرار. هو استبدال[حزمة إعادة قسم مجموعة قرار](2026-07-29-package-regrouping.ar.md) في إبقاء `bash/`،`pty/` و `self-modification/` مجموعة اسم، و اثنان بند مؤقت تحديد حزمة اسم. هو فقط استبدال[إزالة SDK مشروع أداة سلسلة](../simplification/2026-08-11-remove-sdk-project-toolchain.ar.md) في سوف كامل مستودع تسمية لـ SDK قول قاعدة؛ بعد من ما زال مسؤول شرح حذف نطاق و إبقاء وقت التشغيل SDK. هو فقط استبدال[أداة استدعاء مهلة سياسة](2026-07-07-tool-call-timeout-policy.ar.md) في حزمة اسم إدارة من؛ مهلة آلية و ذلك `guard/timeout-policy/` ملكية إبقاء ثابت.
