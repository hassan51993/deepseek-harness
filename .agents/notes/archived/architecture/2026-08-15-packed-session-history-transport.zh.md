...
**فقط إرجاع تجميع بعد Assistant لقطة.** [فقط إبقاء تجميع رسالة مرفوض سجل](../../rejected/simplification/2026-06-20-assembled-assistant-messages-only.zh.md) ما زال ملائم استخدام:final message خارج حدث عائلة تحمل تحميل مستخدم مرئي حالة و تشخيص حالة، لم إتمام خطوة أيضا حاجة ذلك فعلي تراكم حساب قسم قطعة.
