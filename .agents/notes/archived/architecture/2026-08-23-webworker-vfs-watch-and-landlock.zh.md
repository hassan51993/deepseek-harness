...
نظام الملفات توافق حد التزام دوران [Worker Node face قرار](2026-08-20-webworker-node-face.zh.md): صاف JavaScript watcher حزمة في Node توافق وحدة لـ فوق إبقاء أصل مثال تشغيل.Native أو binary حزمة يمكن إبقاء عام JavaScript API و يمكن تنفيذ ملف بروتوكول، معا استبدال تنفيذ خلفية. لا يمكن صيانة حمل استدعاء جهة مرئي Node سلوك API متابعة واضح علامة لـ غير ممكن استخدام؛`node:vm` لا يخص هذا قرار نطاق.
