...
قائم[عبر realm Inspector قرار](../../implemented/architecture/2026-08-23-cross-realm-cdp-inspector.ar.md) مسؤول Worker،source carrier،Runtime توجيه و أمان نموذج؛ هذا Note فقط مسؤول Cordis دلالة بيانات و ذلك مستهلك.
