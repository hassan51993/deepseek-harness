...
Also run the repository's skill-invocation metadata check for skill changes and compare English/Arabic physical line counts for a line-aligned pair. Re-read the final diff once for factual completeness and once for brevity, navigation, and ownership.
