...
8. **Authoring-language slips** — untranslated working-language fragments (طرف, تصميم مسودة, `---- خاص ----` separators) in prose whose language is otherwise English, or the reverse in a zh counterpart. Translate or delete.
