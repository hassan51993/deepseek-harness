...
اعتماد حالة حالة استخدام استخدام Workspace، وصل قبول، مرفق عنصر و نموذج تدفق شاشة عائق، منطقة قسم مرئي في بين حالة و اكتمل عملية. تفصيل حال إغلاق انتظار إطار هيكل مرور عبور انتهاء؛ عودة ملف تحقق لـ seed Session ضبط صريح عنوان، و عبر إعادة تحميل تتبع أثر هذا هوية. مشاركة رؤية [CI fixture تزامن قرار](../../../.agents/notes/implemented/testing/2026-09-08-ci-completion-observations.ar.md).
