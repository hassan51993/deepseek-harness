...
export const ar = {
  ...
  startupAddressInUse: 'لديه أخرى صحيح في تشغيل DSH(مثل أخرى dsh web، طاولة وجه طرف) ، لا يمكن معا بدء، طلب خروج أخرى صحيح في تشغيل DSH بعد إعادة بدء.',
  ...
  updateCheckNetworkFailed: 'فحص تحديث فشل، طلب قليلا بعد إعادة محاولة. شبكة شبكة اتصال استثناء، طلب فحص شبكة شبكة بعد إعادة محاولة.',
  updateDownloadNetworkFailed: 'تحت تحميل تحديث فشل، طلب إعادة محاولة. شبكة شبكة اتصال استثناء، طلب فحص شبكة شبكة بعد إعادة محاولة.',
  updateInstallNetworkFailed: 'تثبيت تحديث فشل، طلب قليلا بعد إعادة محاولة. شبكة شبكة اتصال استثناء، طلب فحص شبكة شبكة بعد إعادة محاولة.',
  unknownError: 'لم معرفة خطأ',
  updateCheckTitle: 'فحص تحديث',
  updateCurrent: 'حالي مؤقت بلا متاح تحديث. حالي إصدار:V{version}',
  updateChecking: 'صحيح في فحص تحديث…',
  ...
  updateDownloading: 'صحيح في تحت تحميل {percent}%…',
  updateVerifying: 'صحيح في تحقق تحديث ملف…',
  updateInstalling: 'صحيح في دقيق تجهيز إعادة بدء…',
  ...
  updateTechnicalDetails: 'فحص نظر تقنية فن تفصيل حال',
  ...
  mandatoryUnavailable: 'مؤقت وقت لا يمكن فحص تحديث اشتراط، طلب في شبكة شبكة استعادة بعد إعادة محاولة.',
  ...
  policyLoginFailed: 'اختبار بيئة تسجيل تسجيل لم إتمام، طلب فحص شبكة شبكة بعد إعادة محاولة.',
  policyLoginLoading: 'صحيح في تحميل تسجيل تسجيل صفحة…',
  ...
  mandatoryInspecting: 'صحيح في فحص مهمة حالة…',
  mandatoryStopping: 'صحيح في أمان انتهاء تطبيق في مهمة.',
