...
# دليل أحداث حفظ الجلسة الدائم

[English](persistence-catalog.md) | العربية

يظهر هنا كل حدث جلسة دائم يعلنه المستودع، مع تصريحه في المصدر وأنواعه المحلولة. ويغطي الدليل الترويستين المنطقية والفيزيائية، ومغلّفات الأحداث، وكل دمج تصريحات تسهم به إضافة. انظر [Session](subsystems/session.ar.md) لإعادة التشغيل، و[الحفظ الدائم](subsystems/persistence.ar.md) للتخزين.

شغّل `pnpm run gen-persistence-catalog` لإعادة توليد لغتَي الدليل وسجل اقترانهما ووحدة الأحداث المعروفة وجرد schemas الآلي. ويفحص `pnpm run verify-persistence-catalog` كل الملفات المولَّدة. وتحفظ أسوارُ التصريحات JSDoc المصدر ومراجعَ الأنواع؛ وتكشف التعريفاتُ المحلولة بنيتَها المتعدية.

يحمل المغلّف `type` و`seq` و`time` و`data`، و`ignorable` اختياريًا، و`surfaceOp` و`sourceEventSeqs` شرطيًا. وحدثُ **السطح** ينتج تاريخًا للنموذج؛ وحدثُ **السجل فقط** لا ينتجه. ويغطي الجردُ هذا المستودع؛ أما أنواع الإضافات الخارجية فتشترط تصريحاتها هي وتقع خارج هذا الدليل.
...
المصادر: [`packages/core/session/src/types.ts:409`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:417`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:439`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:470`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/core/agent/src/types.ts:87`](../packages/core/agent/src/types.ts)
...
المصدر: [`packages/preset/agent-presets/src/session.ts:28`](../packages/preset/agent-presets/src/session.ts)
...
الأنواع: [ToolCallId](subsystems/core.ar.md)

المصدر: [`packages/interaction/user-approval/src/types.ts:44`](../packages/interaction/user-approval/src/types.ts)
...
المصدر: [`packages/interaction/user-approval/src/types.ts:55`](../packages/interaction/user-approval/src/types.ts)
...
المصدر: [`packages/interaction/user-approval/src/index.ts:33`](../packages/interaction/user-approval/src/index.ts)
...
المصدر: [`packages/core/session/src/types.ts:335`](../packages/core/session/src/types.ts)
...
الأنواع: [TokenUsage](subsystems/llm-streaming.ar.md)

المصدر: [`packages/core/session/src/types.ts:321`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/interaction/commands/src/types.ts:112`](../packages/interaction/commands/src/types.ts)
...
المصدر: [`packages/interaction/commands/src/types.ts:105`](../packages/interaction/commands/src/types.ts)
...
المصدر: [`packages/compaction/compaction/src/types.ts:72`](../packages/compaction/compaction/src/types.ts)
...
المصدر: [`packages/compaction/compaction/src/types.ts:82`](../packages/compaction/compaction/src/types.ts)
...
المصدر: [`packages/compaction/compaction/src/types.ts:24`](../packages/compaction/compaction/src/types.ts)
...
الأنواع: [ContentBlock](subsystems/core.ar.md) · [TokenUsage](subsystems/llm-streaming.ar.md)

المصدر: [`packages/compaction/compaction/src/types.ts:34`](../packages/compaction/compaction/src/types.ts)
...
الأنواع: [PresentedFile](subsystems/deliverables.ar.md) · [ToolCallId](subsystems/core.ar.md)

المصدر: [`packages/deliverables/tool-present/src/types.ts:15`](../packages/deliverables/tool-present/src/types.ts)
...
المصدر: [`packages/feedback/message-feedback/src/types.ts:58`](../packages/feedback/message-feedback/src/types.ts)
...
المصدر: [`packages/feedback/message-feedback/src/types.ts:56`](../packages/feedback/message-feedback/src/types.ts)
...
المصدر: [`packages/feedback/command-feedback/src/types.ts:40`](../packages/feedback/command-feedback/src/types.ts)
...
المصدر: [`packages/goal/goal/src/domain.ts:66`](../packages/goal/goal/src/domain.ts)
...
المصدر: [`packages/hooks/hook-protocol/src/types.ts:19`](../packages/hooks/hook-protocol/src/types.ts)
...
المصدر: [`packages/hooks/hook-protocol/src/types.ts:31`](../packages/hooks/hook-protocol/src/types.ts)
...
المصدر: [`packages/compaction/compaction-image-offload/src/projection.ts:25`](../packages/compaction/compaction-image-offload/src/projection.ts)
...
المصدر: [`packages/llm/llm-retry/src/types.ts:9`](../packages/llm/llm-retry/src/types.ts)
...
المصدر: [`packages/llm/llm-retry/src/types.ts:11`](../packages/llm/llm-retry/src/types.ts)
...
المصدر: [`packages/api/session-controller/src/types.ts:40`](../packages/api/session-controller/src/types.ts)
...
المصدر: [`packages/interaction/permission-presets/src/index.ts:57`](../packages/interaction/permission-presets/src/index.ts)
...
المصدر: [`packages/plan/plan-mode/src/index.ts:47`](../packages/plan/plan-mode/src/index.ts)
...
المصدر: [`packages/core/session/src/types.ts:382`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:370`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/sandbox/sandbox-policy/src/session-mode.ts:33`](../packages/sandbox/sandbox-policy/src/session-mode.ts)
...
الأنواع: [ScheduleChange](subsystems/schedule.ar.md)

المصدر: [`packages/schedule/schedule/src/types.ts:219`](../packages/schedule/schedule/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:405`](../packages/core/session/src/types.ts)
...
الأنواع: [SessionTitleEventData](subsystems/session-title.ar.md)

المصدر: [`packages/session/session-title/src/index.ts:77`](../packages/session/session-title/src/index.ts)
...
الأنواع: [SessionTitleLlmRequestEventData](subsystems/session-title.ar.md)

المصدر: [`packages/session/session-title-llm/src/index.ts:45`](../packages/session/session-title-llm/src/index.ts)
...
المصدر: [`packages/session/session-log-deepseek/src/types.ts:81`](../packages/session/session-log-deepseek/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:289`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:287`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/subagent/subagent/src/catalog.ts:40`](../packages/subagent/subagent/src/catalog.ts)
...
المصدر: [`packages/subagent/subagent/src/descriptor.ts:38`](../packages/subagent/subagent/src/descriptor.ts)
...
المصدر: [`packages/subagent/tool-subagent/src/model-selection-state.ts:17`](../packages/subagent/tool-subagent/src/model-selection-state.ts)
...
المصدر: [`packages/core/session/src/types.ts:310`](../packages/core/session/src/types.ts)
...
الأنواع: [TeamId](subsystems/agent-team.ar.md) · [TeamMemberSnapshot](subsystems/agent-team.ar.md)

المصدر: [`packages/experimental/agent-team/src/types.ts:221`](../packages/experimental/agent-team/src/types.ts)
...
الأنواع: [TeamId](subsystems/agent-team.ar.md) · [TeamMessageId](subsystems/agent-team.ar.md)

المصدر: [`packages/experimental/agent-team/src/types.ts:227`](../packages/experimental/agent-team/src/types.ts)
...
الأنواع: [TeamId](subsystems/agent-team.ar.md) · [TeamMessageSnapshot](subsystems/agent-team.ar.md)

المصدر: [`packages/experimental/agent-team/src/types.ts:225`](../packages/experimental/agent-team/src/types.ts)
...
الأنواع: [TeamId](subsystems/agent-team.ar.md) · [TeamTaskSnapshot](subsystems/agent-team.ar.md)

المصدر: [`packages/experimental/agent-team/src/types.ts:223`](../packages/experimental/agent-team/src/types.ts)
...
الأنواع: [TodoItem](subsystems/todo.ar.md)

المصدر: [`packages/todo/tool-todo/src/types.ts:31`](../packages/todo/tool-todo/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:341`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/core/tools/src/types.ts:58`](../packages/core/tools/src/types.ts)
...
المصدر: [`packages/core/tools/src/types.ts:42`](../packages/core/tools/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:355`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/workflow/tool-workflow/src/types.ts:57`](../packages/workflow/tool-workflow/src/types.ts)
...
المصدر: [`packages/workflow/tool-workflow/src/types.ts:52`](../packages/workflow/tool-workflow/src/types.ts)
...
المصدر: [`packages/workflow/tool-workflow/src/types.ts:62`](../packages/workflow/tool-workflow/src/types.ts)
...
المصدر: [`packages/workflow/tool-workflow/src/types.ts:47`](../packages/workflow/tool-workflow/src/types.ts)
...
الأنواع: [TurnEndReason](subsystems/session.ar.md)

المصدر: [`packages/core/session/src/types.ts:285`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:276`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/core/session/src/types.ts:297`](../packages/core/session/src/types.ts)
...
المصدر: [`packages/web/web-search-deepseek/src/provider.ts:82`](../packages/web/web-search-deepseek/src/provider.ts)
...
المصدر: [`packages/deliverables/workspace-changes/src/types.ts:106`](../packages/deliverables/workspace-changes/src/types.ts)
...
|---|---|---|
| `data` | مطلوبة | [`event:agent-preset/selected.data`](#persistence-type-eventagent-presetselecteddata) |
...
المصادر: [`packages/preset/agent-presets/src/session.ts:28`](../packages/preset/agent-presets/src/session.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:agent/inbox/spliced.data`](#persistence-type-eventagentinboxspliceddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/agent/src/types.ts:87`](../packages/core/agent/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `inserted` | مطلوبة | [`event:agent/inbox/spliced.data.inserted`](#persistence-type-eventagentinboxspliceddatainserted) |
...
المصادر: [`packages/attachment/attachment/src/types.ts:28`](../packages/attachment/attachment/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:189`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:75`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:79`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:103`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/types.ts:35`](../packages/session/session-title/src/types.ts)
...
المصادر: [`packages/api/session-controller/src/types.ts:381`](../packages/api/session-controller/src/types.ts)
...
مصفوفة من [`event:agent/inbox/spliced.data.inserted[0].source[15].references[0]`](#persistence-type-eventagentinboxspliceddatainserted0source15references0).
...
المصادر: [`packages/context/session-reference/src/types.ts:18`](../packages/context/session-reference/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `capturedFormatVersion` | اختيارية | `number` |
| `capturedThroughSeq` | مطلوبة | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
...
مصفوفة من [`event:agent/inbox/spliced.data.inserted[0].source[17].entries[0]`](#persistence-type-eventagentinboxspliceddatainserted0source17entries0).
...
المصادر: [`packages/skill/tool-skill/src/index.ts:40`](../packages/skill/tool-skill/src/index.ts)
...
المصادر: [`packages/webhook/webhook/src/types.ts:74`](../packages/webhook/webhook/src/types.ts)
...
| `kind` | مطلوبة | `"plugin"` |
| `plugin` | مطلوبة | `string` |
| `sections` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].source[4].sections`](#persistence-type-eventagentinboxspliceddatainserted0source4sections) |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:approval/asked.data`](#persistence-type-eventapprovalaskeddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/interaction/user-approval/src/types.ts:44`](../packages/interaction/user-approval/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:approval/decided.data`](#persistence-type-eventapprovaldecideddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/interaction/user-approval/src/types.ts:55`](../packages/interaction/user-approval/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:approval/policy.data`](#persistence-type-eventapprovalpolicydata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/interaction/user-approval/src/index.ts:33`](../packages/interaction/user-approval/src/index.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:assistant/attempt.data`](#persistence-type-eventassistantattemptdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:335`](../packages/core/session/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `step` | مطلوبة | `number` |
| `stream` | مطلوبة | [`event:assistant/attempt.data.stream`](#persistence-type-eventassistantattemptdatastream) |
| `turn` | مطلوبة | `number` |
...
المصادر: [`packages/llm/llm/src/assistant-stream.ts:21`](../packages/llm/llm/src/assistant-stream.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `dt` | مطلوبة | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `index` | مطلوبة | `number` |
| `texts` | مطلوبة | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `time0` | مطلوبة | `number` |
...
المصادر: [`packages/llm/llm/src/assistant-stream.ts:28`](../packages/llm/llm/src/assistant-stream.ts)
...
المصادر: [`packages/llm/llm/src/assistant-stream.ts:35`](../packages/llm/llm/src/assistant-stream.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `args` | مطلوبة | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `dt` | مطلوبة | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `id` | مطلوبة | `string` |
| `index` | مطلوبة | `number` |
...
المصادر: [`packages/llm/llm/src/assistant-stream.ts:44`](../packages/llm/llm/src/assistant-stream.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:427`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:428`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:429`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:430`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:431`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:432`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:433`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:147`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:148`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:213`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:146`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:144`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:145`](../packages/llm/llm/src/types.ts)
...
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `surfaceOp` | مطلوبة | [`packages/core/session/src/types.ts#SurfaceOp`](#persistence-type-packagescoresessionsrctypestssurfaceop) |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:321`](../packages/core/session/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:command/done.data`](#persistence-type-eventcommanddonedata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/interaction/commands/src/types.ts:112`](../packages/interaction/commands/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `commandId` | مطلوبة | `string` |
| `kind` | مطلوبة | [`event:command/done.data.kind`](#persistence-type-eventcommanddonedatakind) |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:command/run.data`](#persistence-type-eventcommandrundata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/interaction/commands/src/types.ts:105`](../packages/interaction/commands/src/types.ts)
...
| `commandId` | مطلوبة | `string` |
| `name` | مطلوبة | `string` |
| `source` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].source[0]`](#persistence-type-eventagentinboxspliceddatainserted0source0) |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:compaction/end.data`](#persistence-type-eventcompactionenddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/compaction/compaction/src/types.ts:72`](../packages/compaction/compaction/src/types.ts)
...
| `turn` | مطلوبة | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
...
المصادر: [`packages/core/session/src/types.ts:64`](../packages/core/session/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:compaction/prune.data`](#persistence-type-eventcompactionprunedata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/compaction/compaction/src/types.ts:82`](../packages/compaction/compaction/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `shadowedRange` | مطلوبة | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | مطلوبة | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
...
المصادر: [`packages/compaction/compaction/src/types.ts:38`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:84`](../packages/compaction/compaction/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:compaction/start.data`](#persistence-type-eventcompactionstartdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/compaction/compaction/src/types.ts:24`](../packages/compaction/compaction/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:compaction/summary.data`](#persistence-type-eventcompactionsummarydata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
| `model` | مطلوبة | `string` |
| `provider` | مطلوبة | `string` |
| `rawOutput` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `shadowedRange` | مطلوبة | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | مطلوبة | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `shadowedTokenCount` | مطلوبة | `number` |
| `sourceCommandId` | اختيارية | `string` |
| `summary` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `usage` | اختيارية | [`packages/llm/llm/src/types.ts#TokenUsage`](#persistence-type-packagesllmllmsrctypeststokenusage) |
...
| `model` | مطلوبة | `string` |
| `provider` | مطلوبة | `string` |
| `rawOutput` | اختيارية | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `shadowedRange` | مطلوبة | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | مطلوبة | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `shadowedTokenCount` | مطلوبة | `number` |
| `sourceCommandId` | اختيارية | `string` |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:deliverables/presented.data`](#persistence-type-eventdeliverablespresenteddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
| `type` | مطلوبة | `"deliverables/presented"` |
...
المصادر: [`packages/deliverables/tool-present/src/types.ts:15`](../packages/deliverables/tool-present/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `callId` | مطلوبة | `string` |
| `files` | مطلوبة | [`event:deliverables/presented.data.files`](#persistence-type-eventdeliverablespresenteddatafiles) |
| `turn` | مطلوبة | `number` |
...
مصفوفة من [`packages/deliverables/tool-present/src/types.ts#PresentedFile`](#persistence-type-packagesdeliverablestool-presentsrctypestspresentedfile).
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`packages/feedback/command-feedback/src/types.ts#FeedbackRecord`](#persistence-type-packagesfeedbackcommand-feedbacksrctypestsfeedbackrecord) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:hook/invoked.data`](#persistence-type-eventhookinvokeddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/hooks/hook-protocol/src/types.ts:19`](../packages/hooks/hook-protocol/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:hook/result.data`](#persistence-type-eventhookresultdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/hooks/hook-protocol/src/types.ts:31`](../packages/hooks/hook-protocol/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:image/offload.data`](#persistence-type-eventimageoffloaddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
| `type` | مطلوبة | `"image/offload"` |
...
المصادر: [`packages/compaction/compaction-image-offload/src/projection.ts:25`](../packages/compaction/compaction-image-offload/src/projection.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `targets` | مطلوبة | [`event:image/offload.data.targets`](#persistence-type-eventimageoffloaddatatargets) |
...
مصفوفة من [`packages/compaction/compaction-image-offload/src/projection.ts#ImageOffloadTarget`](#persistence-type-packagescompactioncompaction-image-offloadsrcprojectiontsimageoffloadtarget).
...
المصادر: [`packages/llm/llm-retry/src/types.ts:17`](../packages/llm/llm-retry/src/types.ts)
...
المصادر: [`packages/llm/llm-retry/src/types.ts:30`](../packages/llm/llm-retry/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:permission/preset.data`](#persistence-type-eventpermissionpresetdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/interaction/permission-presets/src/index.ts:57`](../packages/interaction/permission-presets/src/index.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:plan/mode.data`](#persistence-type-eventplanmodedata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/plan/plan-mode/src/index.ts:47`](../packages/plan/plan-mode/src/index.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:request/header.data`](#persistence-type-eventrequestheaderdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:370`](../packages/core/session/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:sandbox/mode.data`](#persistence-type-eventsandboxmodedata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/sandbox/sandbox-policy/src/session-mode.ts:33`](../packages/sandbox/sandbox-policy/src/session-mode.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:session-log-deepseek/delivery-accepted.data`](#persistence-type-eventsession-log-deepseekdelivery-accepteddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/session/session-log-deepseek/src/types.ts:81`](../packages/session/session-log-deepseek/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:session/end-seed.data`](#persistence-type-eventsessionend-seeddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:405`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/session/session-title/src/types.ts:29`](../packages/session/session-title/src/types.ts)
...
المصادر: [`packages/session/session-title/src/types.ts:30`](../packages/session/session-title/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `kind` | مطلوبة | `"provider"` |
| `model` | اختيارية | [`packages/session/session-title/src/types.ts#SessionTitleModelIdentity`](#persistence-type-packagessessionsession-titlesrctypestssessiontitlemodelidentity) |
| `provider` | مطلوبة | `string` |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:step/end.data`](#persistence-type-eventstependdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:287`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:289`](../packages/core/session/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`packages/subagent/subagent/src/catalog.ts#SubagentCatalogEvent`](#persistence-type-packagessubagentsubagentsrccatalogtssubagentcatalogevent) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
| `type` | مطلوبة | `"subagent/catalog"` |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:subagent/model-selection-policy.data`](#persistence-type-eventsubagentmodel-selection-policydata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/subagent/tool-subagent/src/model-selection-state.ts:17`](../packages/subagent/tool-subagent/src/model-selection-state.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `allowedModels` | مطلوبة | [`event:subagent/model-selection-policy.data.allowedModels`](#persistence-type-eventsubagentmodel-selection-policydataallowedmodels) |
...
مصفوفة من [`packages/session/session-title/src/types.ts#SessionTitleModelIdentity`](#persistence-type-packagessessionsession-titlesrctypestssessiontitlemodelidentity).
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:system/message.data`](#persistence-type-eventsystemmessagedata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `sourceEventSeqs` | اختيارية | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `surfaceOp` | مطلوبة | [`packages/core/session/src/types.ts#SurfaceOp`](#persistence-type-packagescoresessionsrctypestssurfaceop) |
| `time` | مطلوبة | `number` |
| `type` | مطلوبة | `"system/message"` |
...
المصادر: [`packages/core/session/src/types.ts:310`](../packages/core/session/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `message` | مطلوبة | [`packages/llm/llm/src/message.ts#SystemMessage`](#persistence-type-packagesllmllmsrcmessagetssystemmessage) |
| `step` | مطلوبة | `number` |
| `turn` | مطلوبة | `number` |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:team/member.data`](#persistence-type-eventteammemberdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/experimental/agent-team/src/types.ts:221`](../packages/experimental/agent-team/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:team/message/delivered.data`](#persistence-type-eventteammessagedelivereddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/experimental/agent-team/src/types.ts:227`](../packages/experimental/agent-team/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:team/message/queued.data`](#persistence-type-eventteammessagequeueddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/experimental/agent-team/src/types.ts:225`](../packages/experimental/agent-team/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:team/task.data`](#persistence-type-eventteamtaskdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/experimental/agent-team/src/types.ts:223`](../packages/experimental/agent-team/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:todo/write.data`](#persistence-type-eventtodowritedata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/todo/tool-todo/src/types.ts:31`](../packages/todo/tool-todo/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `todos` | مطلوبة | [`event:todo/write.data.todos`](#persistence-type-eventtodowritedatatodos) |
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:tool/call.data`](#persistence-type-eventtoolcalldata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:341`](../packages/core/session/src/types.ts)
...
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
| `type` | مطلوبة | `"tool/ptc-dispatch-start"` |
...
المصادر: [`packages/core/session/src/types.ts:363`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:24`](../packages/core/tools/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:355`](../packages/core/session/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `error` | اختيارية | [`event:tool/ptc-dispatch.data.error`](#persistence-type-eventtoolptc-dispatchdataerror) |
...
المصادر: [`packages/util/values/src/index.ts:4`](../packages/util/values/src/index.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:turn/end.data`](#persistence-type-eventturnenddata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:285`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:201`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:203`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:190`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:191`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:192`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:195`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:205`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:211`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:220`](../packages/core/session/src/types.ts)
...
| الخاصية | الحضور | النوع |
|---|---|---|
| `data` | مطلوبة | [`event:turn/start.data`](#persistence-type-eventturnstartdata) |
| `ignorable` | اختيارية | `true` |
| `seq` | مطلوبة | `number` |
| `time` | مطلوبة | `number` |
...
المصادر: [`packages/core/session/src/types.ts:276`](../packages/core/session/src/types.ts) · [`packages/deliverables/workspace-changes/src/types.ts:106`](../packages/deliverables/workspace-changes/src/types.ts)
...
المصادر: [`packages/web/web-search-deepseek/src/provider.ts:61`](../packages/web/web-search-deepseek/src/provider.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `max_tokens` | مطلوبة | `number` |
| `messages` | مطلوبة | [`event:web/deepseek-search-llm-request.data.body.messages`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages) |
| `model` | مطلوبة | `string` |
| `tools` | مطلوبة | [`event:web/deepseek-search-llm-request.data.body.tools`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodytools) |
...
| الموضع | الحضور | النوع |
|---|---|---|
| 0 | مطلوبة | [`event:web/deepseek-search-llm-request.data.body.messages[0]`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages0) |
...
المصادر: [`packages/web/web-search-deepseek/src/provider.ts:64`](../packages/web/web-search-deepseek/src/provider.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `content` | مطلوبة | [`event:web/deepseek-search-llm-request.data.body.messages[0].content`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages0content) |
| `role` | مطلوبة | `"user"` |
...
| الموضع | الحضور | النوع |
|---|---|---|
| 0 | مطلوبة | [`event:web/deepseek-search-llm-request.data.body.messages[0].content[0]`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages0content0) |
...
المصادر: [`packages/llm/llm/src/types.ts:61`](../packages/llm/llm/src/types.ts) · [`packages/web/web-search-deepseek/src/provider.ts:66`](../packages/web/web-search-deepseek/src/provider.ts)
...
| الموضع | الحضور | النوع |
|---|---|---|
| 0 | مطلوبة | [`event:web/deepseek-search-llm-request.data.body.tools[0]`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodytools0) |
...
المصادر: [`packages/web/web-search-deepseek/src/provider.ts:71`](../packages/web/web-search-deepseek/src/provider.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:383`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:31`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/api/session-controller/src/types.ts:86`](../packages/api/session-controller/src/types.ts)
...
المصادر: [`packages/attachment/attachment/src/types.ts:39`](../packages/attachment/attachment/src/types.ts)
...
المصادر: [`packages/attachment/attachment/src/types.ts:11`](../packages/attachment/attachment/src/types.ts)
...
| `name` | اختيارية | `string` |
| `originalDimensions` | اختيارية | [`event:agent/inbox/spliced.data.inserted[0].content[0][2].attachment.originalDimensions`](#persistence-type-eventagentinboxspliceddatainserted0content02attachmentoriginaldimensions) |
| `width` | مطلوبة | `number` |
...
المصادر: [`packages/attachment/attachment/src/types.ts:8`](../packages/attachment/attachment/src/types.ts)
...
المصادر: [`packages/compaction/compaction-image-offload/src/projection.ts:9`](../packages/compaction/compaction-image-offload/src/projection.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `imageIndexes` | مطلوبة | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `seq` | مطلوبة | `number` |
...
المصادر: [`packages/context/agent-instructions/src/render.ts:47`](../packages/context/agent-instructions/src/render.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `action` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].source[16].changes[0].action`](#persistence-type-eventagentinboxspliceddatainserted0source16changes0action) |
...
المصادر: [`packages/context/agent-instructions/src/state.ts:37`](../packages/context/agent-instructions/src/state.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `baseline` | اختيارية | `true` |
| `baselineIdentity` | اختيارية | `string` |
| `changes` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].source[16].changes`](#persistence-type-eventagentinboxspliceddatainserted0source16changes) |
| `form` | مطلوبة | `"instructions"` |
...
المصادر: [`packages/context/session-reference/src/types.ts:13`](../packages/context/session-reference/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `form` | مطلوبة | `"recall"` |
| `kind` | مطلوبة | `"session-reference"` |
| `references` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].source[15].references`](#persistence-type-eventagentinboxspliceddatainserted0source15references) |
| `version` | مطلوبة | `1` |
...
المصادر: [`packages/core/agent/src/types.ts:30`](../packages/core/agent/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:232`](../packages/core/session/src/types.ts)
...
| `tools` | اختيارية | [`event:request/header.data.header.tools`](#persistence-type-eventrequestheaderdataheadertools) |
...
المصادر: [`packages/core/session/src/types.ts:242`](../packages/core/session/src/types.ts)
...
| `model` | مطلوبة | `string` |
| `provider` | مطلوبة | `string` |
| `systemPromptUpdate` | اختيارية | `"in-history"` |
...
المصادر: [`packages/core/session/src/types.ts:261`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:93`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:439`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:224`](../packages/core/session/src/types.ts)
...
المصادر: [`packages/core/tools/src/index.ts:682`](../packages/core/tools/src/index.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `allow` | اختيارية | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `deny` | اختيارية | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
...
المصادر: [`packages/core/tools/src/types.ts:20`](../packages/core/tools/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `arguments` | مطلوبة | `unknown` (معتم) |
| `content` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `error` | اختيارية | [`event:tool/ptc-dispatch.data.error`](#persistence-type-eventtoolptc-dispatchdataerror) |
...
المصادر: [`packages/core/tools/src/types.ts:11`](../packages/core/tools/src/types.ts)
...
المصادر: [`packages/deliverables/tool-present/src/types.ts:5`](../packages/deliverables/tool-present/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `description` | اختيارية | `string` |
| `path` | مطلوبة | `string` |
...
المصادر: [`packages/experimental/agent-team/src/types.ts:44`](../packages/experimental/agent-team/src/types.ts)
...
المصادر: [`packages/experimental/agent-team/src/types.ts:47`](../packages/experimental/agent-team/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `context` | مطلوبة | [`event:team/member.data.member.context`](#persistence-type-eventteammemberdatamembercontext) |
| `description` | مطلوبة | `string` |
| `error` | اختيارية | `string` |
| `id` | مطلوبة | `string` |
| `name` | مطلوبة | `string` |
...
المصادر: [`packages/experimental/agent-team/src/types.ts:106`](../packages/experimental/agent-team/src/types.ts)
...
المصادر: [`packages/experimental/agent-team/src/types.ts:115`](../packages/experimental/agent-team/src/types.ts)
...
المصادر: [`packages/experimental/agent-team/src/types.ts:74`](../packages/experimental/agent-team/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `blockedBy` | مطلوبة | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `description` | مطلوبة | `string` |
| `id` | مطلوبة | `string` |
...
| `writeScopes` | مطلوبة | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
...
المصادر: [`packages/experimental/agent-team/src/types.ts:71`](../packages/experimental/agent-team/src/types.ts)
...
المصادر: [`packages/feedback/command-feedback/src/types.ts:27`](../packages/feedback/command-feedback/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `category` | اختيارية | [`event:feedback/message-put.data.item.category`](#persistence-type-eventfeedbackmessage-putdataitemcategory) |
| `text` | اختيارية | `string` |
...
المصادر: [`packages/feedback/message-feedback/src/types.ts:46`](../packages/feedback/message-feedback/src/types.ts)
...
المصادر: [`packages/feedback/message-feedback/src/types.ts:20`](../packages/feedback/message-feedback/src/types.ts)
...
المصادر: [`packages/feedback/message-feedback/src/types.ts:38`](../packages/feedback/message-feedback/src/types.ts)
...
المصادر: [`packages/feedback/message-feedback/src/types.ts:17`](../packages/feedback/message-feedback/src/types.ts)
...
المصادر: [`packages/goal/goal/src/domain.ts:44`](../packages/goal/goal/src/domain.ts)
...
المصادر: [`packages/goal/goal/src/domain.ts:35`](../packages/goal/goal/src/domain.ts)
...
المصادر: [`packages/goal/goal/src/domain.ts:47`](../packages/goal/goal/src/domain.ts)
...
المصادر: [`packages/goal/goal/src/domain.ts:24`](../packages/goal/goal/src/domain.ts)
...
| `kind` | مطلوبة | `"goal/change"` |
| `operation` | مطلوبة | [`event:goal/change.data[0].operation`](#persistence-type-eventgoalchangedata0operation) |
...
المصادر: [`packages/goal/goal/src/types.ts:52`](../packages/goal/goal/src/types.ts)
...
المصادر: [`packages/goal/goal/src/types.ts:45`](../packages/goal/goal/src/types.ts)
...
المصادر: [`packages/goal/goal/src/types.ts:20`](../packages/goal/goal/src/types.ts)
...
المصادر: [`packages/goal/goal/src/types.ts:60`](../packages/goal/goal/src/types.ts)
...
المصادر: [`packages/hooks/hook-protocol/src/types.ts:48`](../packages/hooks/hook-protocol/src/types.ts)
...
المصادر: [`packages/interaction/user-approval/src/index.ts:60`](../packages/interaction/user-approval/src/index.ts)
...
المصادر: [`packages/interaction/user-approval/src/types.ts:32`](../packages/interaction/user-approval/src/types.ts)
...
المصادر: [`packages/llm/llm-retry/src/types.ts:16`](../packages/llm/llm-retry/src/types.ts)
...
المصادر: [`packages/llm/llm-retry/src/types.ts:43`](../packages/llm/llm-retry/src/types.ts)
...
المصادر: [`packages/llm/llm/src/assistant-stream.ts:20`](../packages/llm/llm/src/assistant-stream.ts)
...
المصادر: [`packages/llm/llm/src/call-config.ts:23`](../packages/llm/llm/src/call-config.ts)
...
| `provider` | مطلوبة | `string` |
| `reasoningEffort` | اختيارية | `string` |
| `stop` | اختيارية | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
...
المصادر: [`packages/llm/llm/src/call-config.ts:36`](../packages/llm/llm/src/call-config.ts)
...
المصادر: [`packages/llm/llm/src/message.ts:148`](../packages/llm/llm/src/message.ts)
...
المصادر: [`packages/llm/llm/src/message.ts:65`](../packages/llm/llm/src/message.ts)
...
المصادر: [`packages/llm/llm/src/message.ts:131`](../packages/llm/llm/src/message.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `content` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `id` | مطلوبة | `string` |
| `role` | مطلوبة | [`event:session/title-llm-request.data.messages[0].role`](#persistence-type-eventsessiontitle-llm-requestdatamessages0role) |
...
المصادر: [`packages/llm/llm/src/message.ts:128`](../packages/llm/llm/src/message.ts)
...
المصادر: [`packages/llm/llm/src/message.ts:24`](../packages/llm/llm/src/message.ts)
...
المصادر: [`packages/llm/llm/src/message.ts:158`](../packages/llm/llm/src/message.ts)
...
| `id` | مطلوبة | `string` |
| `role` | مطلوبة | `"system"` |
| `source` | مطلوبة | [`event:system/message.data.message.source`](#persistence-type-eventsystemmessagedatamessagesource) |
...
المصادر: [`packages/llm/llm/src/message.ts:29`](../packages/llm/llm/src/message.ts)
...
المصادر: [`packages/llm/llm/src/message.ts:164`](../packages/llm/llm/src/message.ts)
...
المصادر: [`packages/llm/llm/src/message.ts:143`](../packages/llm/llm/src/message.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:137`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:135`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:97`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:152`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:78`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:40`](../packages/llm/llm/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `code` | مطلوبة | `string` |
| `message` | مطلوبة | `string` |
| `offloadImages` | اختيارية | `number` |
...
المصادر: [`packages/llm/llm/src/types.ts:67`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:404`](../packages/llm/llm/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `blocks` | اختيارية | [`event:assistant/attempt.data.stream[0][3].chunk[6].replayState.blocks`](#persistence-type-eventassistantattemptdatastream03chunk6replaystateblocks) |
...
المصادر: [`packages/llm/llm/src/types.ts:426`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:162`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:104`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:114`](../packages/llm/llm/src/types.ts)
...
المصادر: [`packages/llm/llm/src/types.ts:447`](../packages/llm/llm/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `description` | مطلوبة | `string` |
| `name` | مطلوبة | `string` |
| `parameters` | مطلوبة | [`event:request/header.data.header.tools[0].parameters`](#persistence-type-eventrequestheaderdataheadertools0parameters) |
...
المصادر: [`packages/sandbox/sandbox/src/index.ts:29`](../packages/sandbox/sandbox/src/index.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:13`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:27`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:93`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:39`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:86`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:105`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:72`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:79`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/schedule/schedule/src/types.ts:69`](../packages/schedule/schedule/src/types.ts)
...
المصادر: [`packages/session/session-persistence-jsonl/src/format.ts:82`](../packages/session/session-persistence-jsonl/src/format.ts)
...
المصادر: [`packages/session/session-title-llm/src/index.ts:27`](../packages/session/session-title-llm/src/index.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `maxTokens` | مطلوبة | `number` |
| `messageSeqs` | مطلوبة | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `messages` | مطلوبة | [`event:session/title-llm-request.data.messages`](#persistence-type-eventsessiontitle-llm-requestdatamessages) |
| `route` | مطلوبة | [`packages/session/session-title/src/types.ts#SessionTitleModelIdentity`](#persistence-type-packagessessionsession-titlesrctypestssessiontitlemodelidentity) |
...
المصادر: [`packages/session/session-title/src/types.ts:41`](../packages/session/session-title/src/types.ts)
...
المصادر: [`packages/session/session-title/src/types.ts:20`](../packages/session/session-title/src/types.ts) · [`packages/subagent/tool-subagent/src/model-selection.ts:9`](../packages/subagent/tool-subagent/src/model-selection.ts)
...
المصادر: [`packages/session/session-title/src/types.ts:28`](../packages/session/session-title/src/types.ts)
...
المصادر: [`packages/skill/skill/src/index.ts:146`](../packages/skill/skill/src/index.ts)
...
المصادر: [`packages/skill/tool-skill/src/index.ts:34`](../packages/skill/tool-skill/src/index.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `entries` | مطلوبة | [`event:agent/inbox/spliced.data.inserted[0].source[17].entries`](#persistence-type-eventagentinboxspliceddatainserted0source17entries) |
| `form` | مطلوبة | `"catalog"` |
...
المصادر: [`packages/subagent/subagent/src/catalog.ts:24`](../packages/subagent/subagent/src/catalog.ts)
...
المصادر: [`packages/subagent/subagent/src/continuation-messages.ts:15`](../packages/subagent/subagent/src/continuation-messages.ts)
...
المصادر: [`packages/subagent/subagent/src/continuation-messages.ts:30`](../packages/subagent/subagent/src/continuation-messages.ts)
...
المصادر: [`packages/subagent/subagent/src/descriptor.ts:72`](../packages/subagent/subagent/src/descriptor.ts)
...
المصادر: [`packages/subagent/subagent/src/descriptor.ts:61`](../packages/subagent/subagent/src/descriptor.ts)
...
المصادر: [`packages/subagent/subagent/src/descriptor.ts:89`](../packages/subagent/subagent/src/descriptor.ts)
...
المصادر: [`packages/todo/tool-todo/src/types.ts:21`](../packages/todo/tool-todo/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `content` | مطلوبة | `string` |
| `status` | مطلوبة | [`event:todo/write.data.todos[0].status`](#persistence-type-eventtodowritedatatodos0status) |
...
المصادر: [`packages/web/web-search-deepseek/src/provider.ts:55`](../packages/web/web-search-deepseek/src/provider.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `apiVersion` | مطلوبة | `string` |
| `body` | مطلوبة | [`event:web/deepseek-search-llm-request.data.body`](#persistence-type-eventwebdeepseek-search-llm-requestdatabody) |
...
المصادر: [`packages/workflow/tool-workflow/src/types.ts:29`](../packages/workflow/tool-workflow/src/types.ts)
...
المصادر: [`packages/workflow/tool-workflow/src/types.ts:20`](../packages/workflow/tool-workflow/src/types.ts)
...
المصادر: [`packages/workflow/tool-workflow/src/types.ts:36`](../packages/workflow/tool-workflow/src/types.ts)
...
المصادر: [`packages/workflow/tool-workflow/src/types.ts:14`](../packages/workflow/tool-workflow/src/types.ts)
...
المصادر: [`packages/workflow/workflow/src/types.ts:110`](../packages/workflow/workflow/src/types.ts)
...
المصادر: [`packages/workflow/workflow/src/types.ts:63`](../packages/workflow/workflow/src/types.ts)
...
المصادر: [`packages/core/session/src/types.ts:441`](../packages/core/session/src/types.ts)

| الخاصية | الحضور | النوع |
|---|---|---|
| `endSeq` | مطلوبة | `number` |
| `op` | مطلوبة | `"replace"` |
| `startSeq` | مطلوبة | `number` |
...
المصادر: [`packages/api/session-controller/src/types.ts:376`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:19`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:10`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
