...
# جلسة حفظ دائم حدث دليل

[English](persistence-catalog.md) | العربية

هذا دليل صف خروج مستودع إعلان كل حفظ دائم Session حدث و ذلك شفرة المصدر إعلان و تحليل نوع، تغطية منطق و شيء إدارة header، حدث معلومة غلاف و كل إضافة إعلان دمج. إعادة تشغيل قاعدة مشاركة رؤية [Session](subsystems/session.ar.md) ، تخزين قاعدة مشاركة رؤية[حفظ دائم](subsystems/persistence.ar.md).

تشغيل `pnpm run gen-persistence-catalog` يمكن إعادة توليد دليل اثنان نوع لغة، إعداد مقابل سجل، معروف حدث وحدة و آلة جهاز schema دليل.`pnpm run verify-persistence-catalog` فحص كل توليد ملف. إعلان محيط شريط إبقاء شفرة المصدر JSDoc و نوع مرجع؛ تحليل بعد تعريف توسيع ذلك نقل تمرير مرجع بنية.

معلومة غلاف يتضمن `type`،`seq`،`time`،`data`، اختياري `ignorable` و شرط حقل `surfaceOp` / `sourceEventSeqs`.**surface** حدث إنتاج نموذج تاريخ،**log-only** حدث لا إنتاج نموذج تاريخ. دليل تغطية هذا مستودع؛ خارجي إضافة نوع حاجة مستقل إعلان، لا يخص هذا دليل.

## حفظ دائم نوع إشارة نقش

[آلة جهاز يمكن قراءة دليل](persistence-schema.json) يتضمن كل يمكن بلوغ مواصفة تحويل نوع و ذلك SHA-256 ملخص. أصل نوع ملخص شمول غطاء مرجع نوع. ملاحظة تفسير، شفرة المصدر موضع، آخر اسم، مسح حذف صنف لوحة علامة،readonly علامة و بلا دلالة تغير حقل، ربط دمج نوع أو تسليم تقاطع نوع إعادة ترتيب لا أثر ملخص؛ عنصر مجموعة ترتيب، خاصية اسم، قيمة نوع و اختياري صفة سوف أثر ملخص. ملخص ثابت وقت، دليل نص و شفرة المصدر موضع ما زال ممكن إنتاج diff.

[صيغة مشاركة اعتبار](persistence-changes/historical-formats/README.ar.md) تغطية كل تاريخ Session صيغة.[تغيير سجل](persistence-changes/README.ar.md) عبر حفظ في هذا شفرة المصدر شجرة في لقطة تأكيد دقيق نوع تحويل. حسب وفق[مراجعة مسار](cookbook/reviewing-persistence-type-changes.ar.md) تصنيف و سجل تغيير. هذه فحص تغطية قد إعلان نوع بنية؛ لا نفاذ واضح تحميل حمل داخلي محتوى و لم تغيير نوع سلوك تغيير لا في فحص نطاق داخل.
...
مصدر:[`packages/core/session/src/types.ts:409`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:417`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:439`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:470`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/agent/src/types.ts:87`](../packages/core/agent/src/types.ts)
...
مصدر:[`packages/preset/agent-presets/src/session.ts:28`](../packages/preset/agent-presets/src/session.ts)
...
نوع:[ToolCallId](subsystems/core.ar.md)

مصدر:[`packages/interaction/user-approval/src/types.ts:44`](../packages/interaction/user-approval/src/types.ts)
...
مصدر:[`packages/interaction/user-approval/src/types.ts:55`](../packages/interaction/user-approval/src/types.ts)
...
مصدر:[`packages/interaction/user-approval/src/index.ts:33`](../packages/interaction/user-approval/src/index.ts)
...
مصدر:[`packages/core/session/src/types.ts:335`](../packages/core/session/src/types.ts)
...
نوع:[TokenUsage](subsystems/llm-streaming.ar.md)

مصدر:[`packages/core/session/src/types.ts:321`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/interaction/commands/src/types.ts:112`](../packages/interaction/commands/src/types.ts)
...
مصدر:[`packages/interaction/commands/src/types.ts:105`](../packages/interaction/commands/src/types.ts)
...
مصدر:[`packages/compaction/compaction/src/types.ts:72`](../packages/compaction/compaction/src/types.ts)
...
مصدر:[`packages/compaction/compaction/src/types.ts:82`](../packages/compaction/compaction/src/types.ts)
...
مصدر:[`packages/compaction/compaction/src/types.ts:24`](../packages/compaction/compaction/src/types.ts)
...
نوع:[ContentBlock](subsystems/core.ar.md) · [TokenUsage](subsystems/llm-streaming.ar.md)

مصدر:[`packages/compaction/compaction/src/types.ts:34`](../packages/compaction/compaction/src/types.ts)
...
نوع:[PresentedFile](subsystems/deliverables.ar.md) · [ToolCallId](subsystems/core.ar.md)

مصدر:[`packages/deliverables/tool-present/src/types.ts:15`](../packages/deliverables/tool-present/src/types.ts)
...
مصدر:[`packages/feedback/message-feedback/src/types.ts:58`](../packages/feedback/message-feedback/src/types.ts)
...
مصدر:[`packages/feedback/message-feedback/src/types.ts:56`](../packages/feedback/message-feedback/src/types.ts)
...
مصدر:[`packages/feedback/command-feedback/src/types.ts:40`](../packages/feedback/command-feedback/src/types.ts)
...
مصدر:[`packages/goal/goal/src/domain.ts:66`](../packages/goal/goal/src/domain.ts)
...
مصدر:[`packages/hooks/hook-protocol/src/types.ts:19`](../packages/hooks/hook-protocol/src/types.ts)
...
مصدر:[`packages/hooks/hook-protocol/src/types.ts:31`](../packages/hooks/hook-protocol/src/types.ts)
...
مصدر:[`packages/compaction/compaction-image-offload/src/projection.ts:25`](../packages/compaction/compaction-image-offload/src/projection.ts)
...
مصدر:[`packages/llm/llm-retry/src/types.ts:9`](../packages/llm/llm-retry/src/types.ts)
...
مصدر:[`packages/llm/llm-retry/src/types.ts:11`](../packages/llm/llm-retry/src/types.ts)
...
مصدر:[`packages/api/session-controller/src/types.ts:40`](../packages/api/session-controller/src/types.ts)
...
مصدر:[`packages/interaction/permission-presets/src/index.ts:57`](../packages/interaction/permission-presets/src/index.ts)
...
مصدر:[`packages/plan/plan-mode/src/index.ts:47`](../packages/plan/plan-mode/src/index.ts)
...
مصدر:[`packages/core/session/src/types.ts:382`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:370`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/sandbox/sandbox-policy/src/session-mode.ts:33`](../packages/sandbox/sandbox-policy/src/session-mode.ts)
...
نوع:[ScheduleChange](subsystems/schedule.ar.md)

مصدر:[`packages/schedule/schedule/src/types.ts:219`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:405`](../packages/core/session/src/types.ts)
...
نوع:[SessionTitleEventData](subsystems/session-title.ar.md)

مصدر:[`packages/session/session-title/src/index.ts:77`](../packages/session/session-title/src/index.ts)
...
نوع:[SessionTitleLlmRequestEventData](subsystems/session-title.ar.md)

مصدر:[`packages/session/session-title-llm/src/index.ts:45`](../packages/session/session-title-llm/src/index.ts)
...
مصدر:[`packages/session/session-log-deepseek/src/types.ts:81`](../packages/session/session-log-deepseek/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:289`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:287`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/subagent/subagent/src/catalog.ts:40`](../packages/subagent/subagent/src/catalog.ts)
...
مصدر:[`packages/subagent/subagent/src/descriptor.ts:38`](../packages/subagent/subagent/src/descriptor.ts)
...
مصدر:[`packages/subagent/tool-subagent/src/model-selection-state.ts:17`](../packages/subagent/tool-subagent/src/model-selection-state.ts)
...
مصدر:[`packages/core/session/src/types.ts:310`](../packages/core/session/src/types.ts)
...
نوع:[TeamId](subsystems/agent-team.ar.md) · [TeamMemberSnapshot](subsystems/agent-team.ar.md)

مصدر:[`packages/experimental/agent-team/src/types.ts:221`](../packages/experimental/agent-team/src/types.ts)
...
نوع:[TeamId](subsystems/agent-team.ar.md) · [TeamMessageId](subsystems/agent-team.ar.md)

مصدر:[`packages/experimental/agent-team/src/types.ts:227`](../packages/experimental/agent-team/src/types.ts)
...
نوع:[TeamId](subsystems/agent-team.ar.md) · [TeamMessageSnapshot](subsystems/agent-team.ar.md)

مصدر:[`packages/experimental/agent-team/src/types.ts:225`](../packages/experimental/agent-team/src/types.ts)
...
نوع:[TeamId](subsystems/agent-team.ar.md) · [TeamTaskSnapshot](subsystems/agent-team.ar.md)

مصدر:[`packages/experimental/agent-team/src/types.ts:223`](../packages/experimental/agent-team/src/types.ts)
...
نوع:[TodoItem](subsystems/todo.ar.md)

مصدر:[`packages/todo/tool-todo/src/types.ts:31`](../packages/todo/tool-todo/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:341`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/tools/src/types.ts:58`](../packages/core/tools/src/types.ts)
...
مصدر:[`packages/core/tools/src/types.ts:42`](../packages/core/tools/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:355`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:57`](../packages/workflow/tool-workflow/src/types.ts)
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:52`](../packages/workflow/tool-workflow/src/types.ts)
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:62`](../packages/workflow/tool-workflow/src/types.ts)
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:47`](../packages/workflow/tool-workflow/src/types.ts)
...
نوع:[TurnEndReason](subsystems/session.ar.md)

مصدر:[`packages/core/session/src/types.ts:285`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:276`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:297`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/web/web-search-deepseek/src/provider.ts:82`](../packages/web/web-search-deepseek/src/provider.ts)
...
مصدر:[`packages/deliverables/workspace-changes/src/types.ts:106`](../packages/deliverables/workspace-changes/src/types.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:agent-preset/selected.data`](#persistence-type-eventagent-presetselecteddata) |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:agent/inbox/spliced.data`](#persistence-type-eventagentinboxspliceddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `inserted` | مطلوب | [`event:agent/inbox/spliced.data.inserted`](#persistence-type-eventagentinboxspliceddatainserted) |
...
مصدر:[`packages/attachment/attachment/src/types.ts:28`](../packages/attachment/attachment/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:189`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:75`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:79`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:103`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/types.ts:35`](../packages/session/session-title/src/types.ts)
...
مصدر:[`packages/api/session-controller/src/types.ts:381`](../packages/api/session-controller/src/types.ts)
...
[`event:agent/inbox/spliced.data.inserted[0].source[15].references[0]`](#persistence-type-eventagentinboxspliceddatainserted0source15references0) عدد مجموعة.
...
مصدر:[`packages/context/session-reference/src/types.ts:18`](../packages/context/session-reference/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `capturedFormatVersion` | اختياري | `number` |
| `capturedThroughSeq` | مطلوب | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
...
[`event:agent/inbox/spliced.data.inserted[0].source[17].entries[0]`](#persistence-type-eventagentinboxspliceddatainserted0source17entries0) عدد مجموعة.
...
مصدر:[`packages/skill/tool-skill/src/index.ts:40`](../packages/skill/tool-skill/src/index.ts)
...
مصدر:[`packages/webhook/webhook/src/types.ts:74`](../packages/webhook/webhook/src/types.ts)
...
| `kind` | مطلوب | `"plugin"` |
| `plugin` | مطلوب | `string` |
| `sections` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].source[4].sections`](#persistence-type-eventagentinboxspliceddatainserted0source4sections) |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:approval/asked.data`](#persistence-type-eventapprovalaskeddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:approval/decided.data`](#persistence-type-eventapprovaldecideddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:approval/policy.data`](#persistence-type-eventapprovalpolicydata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:assistant/attempt.data`](#persistence-type-eventassistantattemptdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
|---|---|---|
| `step` | مطلوب | `number` |
| `stream` | مطلوب | [`event:assistant/attempt.data.stream`](#persistence-type-eventassistantattemptdatastream) |
| `turn` | مطلوب | `number` |
...
مصدر:[`packages/llm/llm/src/assistant-stream.ts:21`](../packages/llm/llm/src/assistant-stream.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `dt` | مطلوب | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `index` | مطلوب | `number` |
| `texts` | مطلوب | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `time0` | مطلوب | `number` |
...
مصدر:[`packages/llm/llm/src/assistant-stream.ts:28`](../packages/llm/llm/src/assistant-stream.ts)
...
مصدر:[`packages/llm/llm/src/assistant-stream.ts:35`](../packages/llm/llm/src/assistant-stream.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `args` | مطلوب | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `dt` | مطلوب | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `id` | مطلوب | `string` |
| `index` | مطلوب | `number` |
| `name` | اختياري | `string` |
...
مصدر:[`packages/llm/llm/src/assistant-stream.ts:44`](../packages/llm/llm/src/assistant-stream.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:427`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:428`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:429`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:430`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:431`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:432`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:433`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:147`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:148`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:213`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:146`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:144`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:145`](../packages/llm/llm/src/types.ts)
...
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `surfaceOp` | مطلوب | [`packages/core/session/src/types.ts#SurfaceOp`](#persistence-type-packagescoresessionsrctypestssurfaceop) |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:command/done.data`](#persistence-type-eventcommanddonedata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| `kind` | مطلوب | [`event:command/done.data.kind`](#persistence-type-eventcommanddonedatakind) |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:command/run.data`](#persistence-type-eventcommandrundata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| `commandId` | مطلوب | `string` |
| `name` | مطلوب | `string` |
| `source` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].source[0]`](#persistence-type-eventagentinboxspliceddatainserted0source0) |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:compaction/end.data`](#persistence-type-eventcompactionenddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| `turn` | مطلوب | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
...
مصدر:[`packages/core/session/src/types.ts:64`](../packages/core/session/src/types.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:compaction/prune.data`](#persistence-type-eventcompactionprunedata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `shadowedRange` | مطلوب | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | مطلوب | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
...
مصدر:[`packages/compaction/compaction/src/types.ts:38`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:84`](../packages/compaction/compaction/src/types.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:compaction/start.data`](#persistence-type-eventcompactionstartdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:compaction/summary.data`](#persistence-type-eventcompactionsummarydata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| `model` | مطلوب | `string` |
| `provider` | مطلوب | `string` |
| `rawOutput` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `shadowedRange` | مطلوب | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | مطلوب | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `shadowedTokenCount` | مطلوب | `number` |
| `sourceCommandId` | اختياري | `string` |
| `summary` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `usage` | اختياري | [`packages/llm/llm/src/types.ts#TokenUsage`](#persistence-type-packagesllmllmsrctypeststokenusage) |
...
| `model` | مطلوب | `string` |
| `provider` | مطلوب | `string` |
| `rawOutput` | اختياري | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `shadowedRange` | مطلوب | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | مطلوب | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `shadowedTokenCount` | مطلوب | `number` |
| `sourceCommandId` | اختياري | `string` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:deliverables/presented.data`](#persistence-type-eventdeliverablespresenteddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
| `type` | مطلوب | `"deliverables/presented"` |
...
|---|---|---|
| `callId` | مطلوب | `string` |
| `files` | مطلوب | [`event:deliverables/presented.data.files`](#persistence-type-eventdeliverablespresenteddatafiles) |
| `turn` | مطلوب | `number` |
...
[`packages/deliverables/tool-present/src/types.ts#PresentedFile`](#persistence-type-packagesdeliverablestool-presentsrctypestspresentedfile) عدد مجموعة.
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`packages/feedback/command-feedback/src/types.ts#FeedbackRecord`](#persistence-type-packagesfeedbackcommand-feedbacksrctypestsfeedbackrecord) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:hook/invoked.data`](#persistence-type-eventhookinvokeddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:hook/result.data`](#persistence-type-eventhookresultdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:image/offload.data`](#persistence-type-eventimageoffloaddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
| `type` | مطلوب | `"image/offload"` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `targets` | مطلوب | [`event:image/offload.data.targets`](#persistence-type-eventimageoffloaddatatargets) |
...
[`packages/compaction/compaction-image-offload/src/projection.ts#ImageOffloadTarget`](#persistence-type-packagescompactioncompaction-image-offloadsrcprojectiontsimageoffloadtarget) عدد مجموعة.
...
مصدر:[`packages/llm/llm-retry/src/types.ts:17`](../packages/llm/llm-retry/src/types.ts)
...
مصدر:[`packages/llm/llm-retry/src/types.ts:30`](../packages/llm/llm-retry/src/types.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:permission/preset.data`](#persistence-type-eventpermissionpresetdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:plan/mode.data`](#persistence-type-eventplanmodedata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:request/header.data`](#persistence-type-eventrequestheaderdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:sandbox/mode.data`](#persistence-type-eventsandboxmodedata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:session-log-deepseek/delivery-accepted.data`](#persistence-type-eventsession-log-deepseekdelivery-accepteddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:session/end-seed.data`](#persistence-type-eventsessionend-seeddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
مصدر:[`packages/session/session-title/src/types.ts:29`](../packages/session/session-title/src/types.ts)
...
مصدر:[`packages/session/session-title/src/types.ts:30`](../packages/session/session-title/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `kind` | مطلوب | `"provider"` |
| `model` | اختياري | [`packages/session/session-title/src/types.ts#SessionTitleModelIdentity`](#persistence-type-packagessessionsession-titlesrctypestssessiontitlemodelidentity) |
| `provider` | مطلوب | `string` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:step/end.data`](#persistence-type-eventstependdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
| `type` | مطلوب | `"step/end"` |
...
مصدر:[`packages/core/session/src/types.ts:287`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:289`](../packages/core/session/src/types.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`packages/subagent/subagent/src/catalog.ts#SubagentCatalogEvent`](#persistence-type-packagessubagentsubagentsrccatalogtssubagentcatalogevent) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
| `type` | مطلوب | `"subagent/catalog"` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:subagent/model-selection-policy.data`](#persistence-type-eventsubagentmodel-selection-policydata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `allowedModels` | مطلوب | [`event:subagent/model-selection-policy.data.allowedModels`](#persistence-type-eventsubagentmodel-selection-policydataallowedmodels) |
...
[`packages/session/session-title/src/types.ts#SessionTitleModelIdentity`](#persistence-type-packagessessionsession-titlesrctypestssessiontitlemodelidentity) عدد مجموعة.
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:system/message.data`](#persistence-type-eventsystemmessagedata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `sourceEventSeqs` | اختياري | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `surfaceOp` | مطلوب | [`packages/core/session/src/types.ts#SurfaceOp`](#persistence-type-packagescoresessionsrctypestssurfaceop) |
| `time` | مطلوب | `number` |
| `type` | مطلوب | `"system/message"` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `message` | مطلوب | [`packages/llm/llm/src/message.ts#SystemMessage`](#persistence-type-packagesllmllmsrcmessagetssystemmessage) |
| `step` | مطلوب | `number` |
| `turn` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:team/member.data`](#persistence-type-eventteammemberdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:team/message/delivered.data`](#persistence-type-eventteammessagedelivereddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:team/message/queued.data`](#persistence-type-eventteammessagequeueddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:team/task.data`](#persistence-type-eventteamtaskdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:todo/write.data`](#persistence-type-eventtodowritedata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| خاصية | وجود | نوع |
|---|---|---|
| `todos` | مطلوب | [`event:todo/write.data.todos`](#persistence-type-eventtodowritedatatodos) |
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:tool/call.data`](#persistence-type-eventtoolcalldata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
| `type` | مطلوب | `"tool/ptc-dispatch-start"` |
...
مصدر:[`packages/core/session/src/types.ts:363`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:24`](../packages/core/tools/src/types.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `error` | اختياري | [`event:tool/ptc-dispatch.data.error`](#persistence-type-eventtoolptc-dispatchdataerror) |
...
مصدر:[`packages/util/values/src/index.ts:4`](../packages/util/values/src/index.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:turn/end.data`](#persistence-type-eventturnenddata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
| `type` | مطلوب | `"turn/end"` |
...
مصدر:[`packages/core/session/src/types.ts:201`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:203`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:190`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:191`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:192`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:195`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:205`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:211`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:220`](../packages/core/session/src/types.ts)
...
| خاصية | وجود | نوع |
|---|---|---|
| `data` | مطلوب | [`event:turn/start.data`](#persistence-type-eventturnstartdata) |
| `ignorable` | اختياري | `true` |
| `seq` | مطلوب | `number` |
| `time` | مطلوب | `number` |
...
مصدر:[`packages/core/session/src/types.ts:276`](../packages/core/session/src/types.ts) · [`packages/deliverables/workspace-changes/src/types.ts:106`](../packages/deliverables/workspace-changes/src/types.ts)
...
مصدر:[`packages/web/web-search-deepseek/src/provider.ts:61`](../packages/web/web-search-deepseek/src/provider.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `max_tokens` | مطلوب | `number` |
| `messages` | مطلوب | [`event:web/deepseek-search-llm-request.data.body.messages`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages) |
| `model` | مطلوب | `string` |
| `tools` | مطلوب | [`event:web/deepseek-search-llm-request.data.body.tools`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodytools) |
...
| موضع | وجود | نوع |
|---|---|---|
| 0 | مطلوب | [`event:web/deepseek-search-llm-request.data.body.messages[0]`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages0) |
...
مصدر:[`packages/web/web-search-deepseek/src/provider.ts:64`](../packages/web/web-search-deepseek/src/provider.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `content` | مطلوب | [`event:web/deepseek-search-llm-request.data.body.messages[0].content`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages0content) |
| `role` | مطلوب | `"user"` |
...
| موضع | وجود | نوع |
|---|---|---|
| 0 | مطلوب | [`event:web/deepseek-search-llm-request.data.body.messages[0].content[0]`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessages0content0) |
...
مصدر:[`packages/llm/llm/src/types.ts:61`](../packages/llm/llm/src/types.ts) · [`packages/web/web-search-deepseek/src/provider.ts:66`](../packages/web/web-search-deepseek/src/provider.ts)
...
| موضع | وجود | نوع |
|---|---|---|
| 0 | مطلوب | [`event:web/deepseek-search-llm-request.data.body.tools[0]`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodytools0) |
...
مصدر:[`packages/web/web-search-deepseek/src/provider.ts:71`](../packages/web/web-search-deepseek/src/provider.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:383`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:31`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/api/session-controller/src/types.ts:86`](../packages/api/session-controller/src/types.ts)
...
مصدر:[`packages/attachment/attachment/src/types.ts:39`](../packages/attachment/attachment/src/types.ts)
...
مصدر:[`packages/attachment/attachment/src/types.ts:11`](../packages/attachment/attachment/src/types.ts)
...
| `name` | اختياري | `string` |
| `originalDimensions` | اختياري | [`event:agent/inbox/spliced.data.inserted[0].content[0][2].attachment.originalDimensions`](#persistence-type-eventagentinboxspliceddatainserted0content02attachmentoriginaldimensions) |
| `width` | مطلوب | `number` |
...
مصدر:[`packages/attachment/attachment/src/types.ts:8`](../packages/attachment/attachment/src/types.ts)
...
مصدر:[`packages/compaction/compaction-image-offload/src/projection.ts:9`](../packages/compaction/compaction-image-offload/src/projection.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `imageIndexes` | مطلوب | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `seq` | مطلوب | `number` |
...
مصدر:[`packages/context/agent-instructions/src/render.ts:47`](../packages/context/agent-instructions/src/render.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `action` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].source[16].changes[0].action`](#persistence-type-eventagentinboxspliceddatainserted0source16changes0action) |
...
مصدر:[`packages/context/agent-instructions/src/state.ts:37`](../packages/context/agent-instructions/src/state.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `baseline` | اختياري | `true` |
| `baselineIdentity` | اختياري | `string` |
| `changes` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].source[16].changes`](#persistence-type-eventagentinboxspliceddatainserted0source16changes) |
| `form` | مطلوب | `"instructions"` |
...
مصدر:[`packages/context/session-reference/src/types.ts:13`](../packages/context/session-reference/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `form` | مطلوب | `"recall"` |
| `kind` | مطلوب | `"session-reference"` |
| `references` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].source[15].references`](#persistence-type-eventagentinboxspliceddatainserted0source15references) |
| `version` | مطلوب | `1` |
...
مصدر:[`packages/core/agent/src/types.ts:30`](../packages/core/agent/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:232`](../packages/core/session/src/types.ts)
...
| `tools` | اختياري | [`event:request/header.data.header.tools`](#persistence-type-eventrequestheaderdataheadertools) |
...
مصدر:[`packages/core/session/src/types.ts:242`](../packages/core/session/src/types.ts)
...
| `model` | مطلوب | `string` |
| `provider` | مطلوب | `string` |
| `systemPromptUpdate` | اختياري | `"in-history"` |
...
مصدر:[`packages/core/session/src/types.ts:261`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:93`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:439`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:224`](../packages/core/session/src/types.ts)
...
مصدر:[`packages/core/tools/src/index.ts:682`](../packages/core/tools/src/index.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `allow` | اختياري | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `deny` | اختياري | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
...
مصدر:[`packages/core/tools/src/types.ts:20`](../packages/core/tools/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `arguments` | مطلوب | `unknown`(لا نفاذ واضح) |
| `content` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `error` | اختياري | [`event:tool/ptc-dispatch.data.error`](#persistence-type-eventtoolptc-dispatchdataerror) |
...
مصدر:[`packages/core/tools/src/types.ts:11`](../packages/core/tools/src/types.ts)
...
مصدر:[`packages/deliverables/tool-present/src/types.ts:5`](../packages/deliverables/tool-present/src/types.ts)
...
مصدر:[`packages/experimental/agent-team/src/types.ts:44`](../packages/experimental/agent-team/src/types.ts)
...
مصدر:[`packages/experimental/agent-team/src/types.ts:47`](../packages/experimental/agent-team/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `context` | مطلوب | [`event:team/member.data.member.context`](#persistence-type-eventteammemberdatamembercontext) |
| `description` | مطلوب | `string` |
| `error` | اختياري | `string` |
| `id` | مطلوب | `string` |
| `name` | مطلوب | `string` |
...
مصدر:[`packages/experimental/agent-team/src/types.ts:106`](../packages/experimental/agent-team/src/types.ts)
...
مصدر:[`packages/experimental/agent-team/src/types.ts:115`](../packages/experimental/agent-team/src/types.ts)
...
مصدر:[`packages/experimental/agent-team/src/types.ts:74`](../packages/experimental/agent-team/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `blockedBy` | مطلوب | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
| `description` | مطلوب | `string` |
| `id` | مطلوب | `string` |
...
| `writeScopes` | مطلوب | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
...
مصدر:[`packages/experimental/agent-team/src/types.ts:71`](../packages/experimental/agent-team/src/types.ts)
...
مصدر:[`packages/feedback/command-feedback/src/types.ts:27`](../packages/feedback/command-feedback/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `category` | اختياري | [`event:feedback/message-put.data.item.category`](#persistence-type-eventfeedbackmessage-putdataitemcategory) |
| `text` | اختياري | `string` |
...
مصدر:[`packages/feedback/message-feedback/src/types.ts:46`](../packages/feedback/message-feedback/src/types.ts)
...
مصدر:[`packages/feedback/message-feedback/src/types.ts:20`](../packages/feedback/message-feedback/src/types.ts)
...
مصدر:[`packages/feedback/message-feedback/src/types.ts:38`](../packages/feedback/message-feedback/src/types.ts)
...
مصدر:[`packages/feedback/message-feedback/src/types.ts:17`](../packages/feedback/message-feedback/src/types.ts)
...
مصدر:[`packages/goal/goal/src/domain.ts:44`](../packages/goal/goal/src/domain.ts)
...
مصدر:[`packages/goal/goal/src/domain.ts:35`](../packages/goal/goal/src/domain.ts)
...
مصدر:[`packages/goal/goal/src/domain.ts:47`](../packages/goal/goal/src/domain.ts)
...
مصدر:[`packages/goal/goal/src/domain.ts:24`](../packages/goal/goal/src/domain.ts)
...
| `kind` | مطلوب | `"goal/change"` |
| `operation` | مطلوب | [`event:goal/change.data[0].operation`](#persistence-type-eventgoalchangedata0operation) |
...
مصدر:[`packages/goal/goal/src/types.ts:52`](../packages/goal/goal/src/types.ts)
...
مصدر:[`packages/goal/goal/src/types.ts:45`](../packages/goal/goal/src/types.ts)
...
مصدر:[`packages/goal/goal/src/types.ts:20`](../packages/goal/goal/src/types.ts)
...
مصدر:[`packages/goal/goal/src/types.ts:60`](../packages/goal/goal/src/types.ts)
...
مصدر:[`packages/hooks/hook-protocol/src/types.ts:48`](../packages/hooks/hook-protocol/src/types.ts)
...
مصدر:[`packages/interaction/user-approval/src/index.ts:60`](../packages/interaction/user-approval/src/index.ts)
...
مصدر:[`packages/interaction/user-approval/src/types.ts:32`](../packages/interaction/user-approval/src/types.ts)
...
مصدر:[`packages/llm/llm-retry/src/types.ts:16`](../packages/llm/llm-retry/src/types.ts)
...
مصدر:[`packages/llm/llm-retry/src/types.ts:43`](../packages/llm/llm-retry/src/types.ts)
...
مصدر:[`packages/llm/llm/src/assistant-stream.ts:20`](../packages/llm/llm/src/assistant-stream.ts)
...
مصدر:[`packages/llm/llm/src/call-config.ts:23`](../packages/llm/llm/src/call-config.ts)
...
| `provider` | مطلوب | `string` |
| `reasoningEffort` | اختياري | `string` |
| `stop` | اختياري | [`event:assistant/attempt.data.stream[0][0].texts`](#persistence-type-eventassistantattemptdatastream00texts) |
...
مصدر:[`packages/llm/llm/src/call-config.ts:36`](../packages/llm/llm/src/call-config.ts)
...
مصدر:[`packages/llm/llm/src/message.ts:148`](../packages/llm/llm/src/message.ts)
...
مصدر:[`packages/llm/llm/src/message.ts:65`](../packages/llm/llm/src/message.ts)
...
مصدر:[`packages/llm/llm/src/message.ts:131`](../packages/llm/llm/src/message.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `content` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].content`](#persistence-type-eventagentinboxspliceddatainserted0content) |
| `id` | مطلوب | `string` |
| `role` | مطلوب | [`event:session/title-llm-request.data.messages[0].role`](#persistence-type-eventsessiontitle-llm-requestdatamessages0role) |
...
مصدر:[`packages/llm/llm/src/message.ts:128`](../packages/llm/llm/src/message.ts)
...
مصدر:[`packages/llm/llm/src/message.ts:24`](../packages/llm/llm/src/message.ts)
...
مصدر:[`packages/llm/llm/src/message.ts:158`](../packages/llm/llm/src/message.ts)
...
| `id` | مطلوب | `string` |
| `role` | مطلوب | `"system"` |
| `source` | مطلوب | [`event:system/message.data.message.source`](#persistence-type-eventsystemmessagedatamessagesource) |
...
مصدر:[`packages/llm/llm/src/message.ts:29`](../packages/llm/llm/src/message.ts)
...
مصدر:[`packages/llm/llm/src/message.ts:164`](../packages/llm/llm/src/message.ts)
...
مصدر:[`packages/llm/llm/src/message.ts:143`](../packages/llm/llm/src/message.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:137`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:135`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:97`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:152`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:78`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:40`](../packages/llm/llm/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `code` | مطلوب | `string` |
| `message` | مطلوب | `string` |
| `offloadImages` | اختياري | `number` |
...
مصدر:[`packages/llm/llm/src/types.ts:67`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:404`](../packages/llm/llm/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `blocks` | اختياري | [`event:assistant/attempt.data.stream[0][3].chunk[6].replayState.blocks`](#persistence-type-eventassistantattemptdatastream03chunk6replaystateblocks) |
...
مصدر:[`packages/llm/llm/src/types.ts:426`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:162`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:104`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:114`](../packages/llm/llm/src/types.ts)
...
مصدر:[`packages/llm/llm/src/types.ts:447`](../packages/llm/llm/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `description` | مطلوب | `string` |
| `name` | مطلوب | `string` |
| `parameters` | مطلوب | [`event:request/header.data.header.tools[0].parameters`](#persistence-type-eventrequestheaderdataheadertools0parameters) |
...
مصدر:[`packages/sandbox/sandbox/src/index.ts:29`](../packages/sandbox/sandbox/src/index.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:13`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:27`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:93`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:39`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:86`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:105`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:72`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:79`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/schedule/schedule/src/types.ts:69`](../packages/schedule/schedule/src/types.ts)
...
مصدر:[`packages/session/session-persistence-jsonl/src/format.ts:82`](../packages/session/session-persistence-jsonl/src/format.ts)
...
مصدر:[`packages/session/session-title-llm/src/index.ts:27`](../packages/session/session-title-llm/src/index.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `maxTokens` | مطلوب | `number` |
| `messageSeqs` | مطلوب | [`SessionEventEnvelope[39].sourceEventSeqs`](#persistence-type-sessioneventenvelope39sourceeventseqs) |
| `messages` | مطلوب | [`event:session/title-llm-request.data.messages`](#persistence-type-eventsessiontitle-llm-requestdatamessages) |
| `route` | مطلوب | [`packages/session/session-title/src/types.ts#SessionTitleModelIdentity`](#persistence-type-packagessessionsession-titlesrctypestssessiontitlemodelidentity) |
| `system` | مطلوب | `string` |
...
مصدر:[`packages/session/session-title/src/types.ts:41`](../packages/session/session-title/src/types.ts)
...
مصدر:[`packages/session/session-title/src/types.ts:20`](../packages/session/session-title/src/types.ts) · [`packages/subagent/tool-subagent/src/model-selection.ts:9`](../packages/subagent/tool-subagent/src/model-selection.ts)
...
مصدر:[`packages/session/session-title/src/types.ts:28`](../packages/session/session-title/src/types.ts)
...
مصدر:[`packages/skill/skill/src/index.ts:146`](../packages/skill/skill/src/index.ts)
...
مصدر:[`packages/skill/tool-skill/src/index.ts:34`](../packages/skill/tool-skill/src/index.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `entries` | مطلوب | [`event:agent/inbox/spliced.data.inserted[0].source[17].entries`](#persistence-type-eventagentinboxspliceddatainserted0source17entries) |
| `form` | مطلوب | `"catalog"` |
...
مصدر:[`packages/subagent/subagent/src/catalog.ts:24`](../packages/subagent/subagent/src/catalog.ts)
...
مصدر:[`packages/subagent/subagent/src/continuation-messages.ts:15`](../packages/subagent/subagent/src/continuation-messages.ts)
...
مصدر:[`packages/subagent/subagent/src/continuation-messages.ts:30`](../packages/subagent/subagent/src/continuation-messages.ts)
...
مصدر:[`packages/subagent/subagent/src/descriptor.ts:72`](../packages/subagent/subagent/src/descriptor.ts)
...
مصدر:[`packages/subagent/subagent/src/descriptor.ts:61`](../packages/subagent/subagent/src/descriptor.ts)
...
مصدر:[`packages/subagent/subagent/src/descriptor.ts:89`](../packages/subagent/subagent/src/descriptor.ts)
...
مصدر:[`packages/todo/tool-todo/src/types.ts:21`](../packages/todo/tool-todo/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `content` | مطلوب | `string` |
| `status` | مطلوب | [`event:todo/write.data.todos[0].status`](#persistence-type-eventtodowritedatatodos0status) |
...
مصدر:[`packages/web/web-search-deepseek/src/provider.ts:55`](../packages/web/web-search-deepseek/src/provider.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `apiVersion` | مطلوب | `string` |
| `body` | مطلوب | [`event:web/deepseek-search-llm-request.data.body`](#persistence-type-eventwebdeepseek-search-llm-requestdatabody) |
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:29`](../packages/workflow/tool-workflow/src/types.ts)
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:20`](../packages/workflow/tool-workflow/src/types.ts)
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:36`](../packages/workflow/tool-workflow/src/types.ts)
...
مصدر:[`packages/workflow/tool-workflow/src/types.ts:14`](../packages/workflow/tool-workflow/src/types.ts)
...
مصدر:[`packages/workflow/workflow/src/types.ts:110`](../packages/workflow/workflow/src/types.ts)
...
مصدر:[`packages/workflow/workflow/src/types.ts:63`](../packages/workflow/workflow/src/types.ts)
...
مصدر:[`packages/core/session/src/types.ts:441`](../packages/core/session/src/types.ts)

| خاصية | وجود | نوع |
|---|---|---|
| `endSeq` | مطلوب | `number` |
| `op` | مطلوب | `"replace"` |
| `startSeq` | مطلوب | `number` |
...
مصدر:[`packages/api/session-controller/src/types.ts:376`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:19`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:10`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
