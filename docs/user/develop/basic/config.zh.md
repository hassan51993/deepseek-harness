...
في schema في جدول بلوغ ذاته تمام تجهيز قيد، جعل بلا فاعلية إعداد في إضافة تحميل وقت فشل. مقابل خدمة أو قد تسجيل مورد مرجع حاجة اعتماد حقن؛[خدمة تعليم مسار](../framework/service.zh.md) سوف وسيط تعريف هذا بند اتفاق.
...
- [تحزيم و تثبيت إضافة](./publish.zh.md) — يأخذ إضافة بـ يمكن تثبيت حزمة شكل صيغة تسليم
- [إضافة و دورة الحياة](../framework/index.zh.md) — عميق دخول حل إضافة كامل دورة الحياة
- [خدمة و اعتماد](../framework/service.zh.md) — يجعل أنت إضافة مقابل خارج توفير خدمة
