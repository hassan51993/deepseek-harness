...
هذا تعليم مسار سوف في Web UI في إضافة واحد `greet` أداة. طلب أولا إتمام[رقم واحد إضافة](./index.zh.md) ، و إبقاء منها `scratch-plugin` دليل.
...
- [إضافة إعداد](./config.zh.md) — يجعل سؤال انتظار لغة يمكن إعداد.
- [أداة تحرير كتابة مشاركة اعتبار](../../../cookbook/adding-a-tool.zh.md) — فحص قراءة تضمين طقم schema، مواصفة قيمة، خلفية عمل، سياسة خطاف،PTC mode و UI بطاقة.
- [قدرة قسم طبقة](../practice/index.zh.md) — سوف يمكن استبدال قدرة تفكيك قسم لـ Service Definition،Service Provider و Consumer ثلاثة صنف حزمة.
