...
هذا ثلاثة نسخة**افتراضي إغلاق مشاركة اعتبار إعداد**عبر [`@deepseek-ai/dsh-mcp-client`](../../../packages/mcp/mcp-client/README.zh.md) سوف واحد تسجيل ذاكرة نظام اتصال إلى DSH. طلب اختيار منها واحد نسخة، أو نسخ نفسه عام MCP بند إعداد قدوم اتصال أخرى خادم.
