...
[document حزمة عائلة](../../packages/document/README.ar.md) في Node مضيف فوق سوف Office ملف تحويل لـ PDF. إزالة استهلاك من مسؤول مصدر ملف قراءة تخويل و عرض؛ مشترك مزود مسؤول تحويل، محدود دقيق دخول و مؤقت PDF إعادة استخدام. هذا فرعي نظام لا إنشاء موجه إلى نموذج أداة أو Session حدث.

## كل حق

| كل من | مسؤولية |
|---|---|
| [office-to-pdf](../../packages/document/office-to-pdf/README.ar.md) | `ctx.officeToPdf`: مشترك LibreOffice تحويل، محدود دقيق دخول و PDF ذاكرة مؤقتة |
| [Web bundle](../../packages/bundle/web-app/README.ar.md) | من مضيف إزالة استهلاك من مشترك مفرد عدد يمكن إعداد تحويل مزود |
| [Office معاينة Client](../../packages/client/ui-sidebar-documentpreview/README.ar.md#office-preview) | Office توسيع اسم اختيار،PDF إعادة استخدام و ناقص حرف جسم تلميح |
...
مزود أولا دقيق دخول تأخير متأخر قراءة، مجددا قسم إعداد مصدر ملف بايت؛ حسب محتوى هوية مشترك تحويل، و في إرجاع قبل حذف خاص مؤقت دليل. إرجاع PDF بايت في مزود تحرير بعد ما زال صالح. مصدر ملف و PDF بايت لن دخول Session تخزين. إزالة استهلاك من يمكن عبر[مساحة العمل ملف](../../packages/api/workspace-files/README.ar.md) تنفيذ قد تخويل محدود قراءة.
