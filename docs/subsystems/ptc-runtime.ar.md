...
PTC تنفيذ[قدرة seam](../../.agents/notes/implemented/architecture/2026-06-13-capability-seams.ar.md) عبر [dsh-ptc-runtime](../../packages/ptc-runtime/ptc-runtime) توفير `ctx.ptcRuntime`. هو إبرة مقابل Host ربط تشغيل واحد برنامج، تقرير إبلاغ إخراج، فشل و ملائم استخدام صندوق رملي واقع.PTC تنفيذ هو اختياري قدرة، لا يخص[ذكي جسم حلقة رئيسي جاف](core.ar.md).[PTC أساس أساس](../../.agents/notes/implemented/feature/2026-06-15-ptc.ar.md) مسؤول سجل التسجيل عرض،[نوع تحويل إرجاع اتفاق](../../.agents/notes/implemented/feature/2026-07-20-ptc-typed-tool-returns.ar.md) مسؤول ربط قيمة،[صندوق رملي Node قرار](../../.agents/notes/implemented/architecture/2026-09-11-sandboxed-node-ptc-runtime.ar.md) مسؤول قد إصدار تنفيذ مزود.
...
فشل نوع هو**صحيح تسليم نتيجة، مستقل تقرير إبلاغ**(رؤية [defensive-patterns](../defensive-patterns.ar.md)): ميزانية استهلاك كل لا هو استثناء، في توقف لا هو مهلة، أساس قاع انهيار انهيار (مثل OOM) أيضا لا هو اثنان من في أي واحد:
