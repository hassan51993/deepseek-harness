...
مزود إغلاق وقت أولا إيقاف استقبال استدعاء الأداة، و انتظار ذاتي لديه عمل و مورد تنظيف إتمام، مجددا تحرير مشترك مزود تسجيل. إلغاء لا يمكن سحب إلغاء قد تسليم متصفح عملية.
