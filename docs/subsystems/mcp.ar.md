...
[أصلي Cua Driver مزود](../../packages/experimental/computer-use-cua-driver-native/README.ar.md) إعادة استخدام عميل توجيه خروج نتيجة مهايئ، بلا حاجة فتح MCP اتصال. طاولة وجه مزود اختيار يخص[حساب حساب آلة استخدام فرعي نظام](computer-use.ar.md).
