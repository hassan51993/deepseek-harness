...
في نفس تركيب في تركيب [`dsh-browser-use`](../../packages/browser-use/browser-use/README.zh.md) و واحد مزود. هذه مزود هو فعلي تحقق صفة عام مشترك npm حزمة، حاجة صريح تنشيط. هو جمع الأكثر أول دعم حمل متصفح جذب محرك هو Chromium.

| مزود | تجميع صار طريقة |
|---|---|
| [Playwright MCP](../../packages/experimental/browser-use-playwright-mcp/README.zh.md) | Playwright متصفح تحكم MCP أداة |
| [Chrome DevTools MCP](../../packages/experimental/browser-use-chrome-devtools-mcp/README.zh.md) | عبر MCP إجراء Chrome DevTools فحص و تحكم |
| [Stagehand](../../packages/experimental/browser-use-stagehand-native/README.zh.md) | أصلي متصفح عملية، دعم حمل AI(شخص عمل ذكي) مساعد مساعدة حركة عمل، مراقبة قياس و رفع أخذ |
...
متصفح MCP اتصال أيضا توفير[مورد و خادم إشارة أمر](mcp.zh.md). إرسال نحو متصفح خادم مورد استدعاء استخدام ذلك Session طابور صف، و رفض أخرى Session طلب؛ خادم إشارة أمر فقط سوف تجميع إلى الذي تابع Session نص التوجيه في.

[قرار سجل](../../.agents/notes/implemented/architecture/2026-09-12-browser-use-provider-registration.zh.md) حل تفسير فقط تسجيل اسم خدمة و حسب Session إدارة كل حق.
