...
[`dsh-commands`](../../packages/interaction/commands) توفير مستخدم أمر سجل التسجيل خدمة. تفاعل صيغة مهايئ استخدام هو اكتشاف إضافة يملك أمر، و إبرة مقابل تأكيد قطع agent(ذكي جسم) مباشر تنفيذ هذه أمر، بينما لا إنشاء نموذج رسالة.[أمر Agent Note](../../.agents/notes/implemented/feature/2026-07-19-plugin-command-registration.ar.md) مسؤول توزيع و دورة الحياة قرار اعتماد حسب؛[حزمة README](../../packages/interaction/commands/README.ar.md) مسؤول تركيب طريقة و حد.
