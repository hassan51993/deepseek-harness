...
PTY خلفية،`ctx.terminals` و موجه إلى نموذج مستهلك مشترك نوع.[حمل دائم PTY Agent Note](../../.agents/notes/implemented/feature/2026-07-16-persistent-pty-sessions.ar.md) مسؤول سجل قرار اعتماد حسب؛ هذا صفحة سجل قدوم ذاتي [`packages/terminal/terminal/src/types.ts`](../../packages/terminal/terminal/src/types.ts) عبر حزمة مفردات.
