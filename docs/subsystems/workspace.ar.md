...
`WorkspaceId` هو[صنف لوحة تحويل id](core.ar.md#branded-ids). مسار معرف و لـ قسم مغادرة:`realpathNormalize`(`fs.realpath`؛ ذيل جزء مائل عمود،`..` و رمز رقم رابط الكل تحليل) هو وحيد واحد طقم وحيد صفة مواصفة——مساحة العمل مسار بـ مواصفة تحويل شكل صيغة تخزين، وحيد صفة أي مواصفة مسار نص متبادل انتظار (إشارة نحو قد يتم يملك دليل رمز رقم رابط سوف و لـ اندفاع مفاجئ) ،attach وقت جلسة cwd فحص أيضا مشي نفس طقم مواصفة.
