...
كل تطبيق في خدمة اسم مشترك استخدام واحد مسطح مستو نطاق الأسماء. طلب لـ ذاتي لديه خدمة إضافة لديه تمييز تعرف درجة بادئة أو نطاق الأسماء (harness قد احتلال استخدام `tools` و `llm` انتظار عادي اسم) ؛[فرعي نظام صفحة](../subsystems/core.zh.md) فوق توليد `cordis-surface` منطقة كتلة صف خروج harness تسجيل كل اسم.

تحت واحد فصل:[حدث](04-events.zh.md): بلا حاجة مشترك خدمة يكفي عبر معلومة.
