...
إزالة سوف تحرير effect([رقم 2 فصل](02-lifecycle-and-effects.ar.md)) ، تحميل فإن التزام دوران اعتماد علاقة ([رقم 3 فصل](03-services.ar.md)) ، لذلك HMR يمكن أولا إزالة، مجددا تحميل، بـ استبدال صحيح في تشغيل إضافة.`@deepseek-ai/dsh-hmr` إضافة سوف مراقبة نظر ملف، و في حفظ وقت تنفيذ هذا واحد مرور مسار.
