...
خدمة دعم حمل مباشر استدعاء؛**حدث**يجعل إضافة بلا حاجة معرفة طريق لديه أي بعض إضافة جارٍ استماع، حينئذ قدرة إرسال خروج إشعار.harness استخدام حدث معالجة أداة نتيجة، نموذج طلب و مراجعة دفعة قرار انتظار تفاعل.
