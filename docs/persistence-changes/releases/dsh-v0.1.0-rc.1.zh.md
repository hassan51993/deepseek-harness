---
description: "عودة تتبع dsh-v0.1.0-rc.1 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.1.0-rc.1
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.1.0-rc.1` |
| شفرة المصدر يوم مدة | 2026-08-13T08:51:36.000Z |
| إرسال سطر سجل | فقط لديه tag، لا يوجد release كائن. |
| قبل واحد إصدار | [dsh-v0.0.1-rc.5](dsh-v0.0.1-rc.5.zh.md) |
...
| هذا بند لقطة | [dsh-v0.1.0-rc.1.schema.json](dsh-v0.1.0-rc.1.schema.json) |
