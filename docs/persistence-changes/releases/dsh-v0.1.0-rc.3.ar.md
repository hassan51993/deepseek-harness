---
description: "عودة تتبع dsh-v0.1.0-rc.3 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.1.0-rc.3
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.1.0-rc.3` |
| شفرة المصدر يوم مدة | 2026-08-13T10:40:08.000Z |
| إرسال سطر سجل | فقط لديه tag، لا يوجد release كائن. |
| قبل واحد إصدار | [dsh-v0.1.0-rc.2](dsh-v0.1.0-rc.2.ar.md) |
...
| هذا بند لقطة | [dsh-v0.1.0-rc.3.schema.json](dsh-v0.1.0-rc.3.schema.json) |
