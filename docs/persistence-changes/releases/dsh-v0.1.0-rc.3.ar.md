---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.0-rc.3."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.0-rc.3

[English](dsh-v0.1.0-rc.3.md) | العربية
...
|---|---|
| وسم المصدر | `dsh-v0.1.0-rc.3` |
| تاريخ المصدر | 2026-08-13T10:40:08.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.1.0-rc.2](dsh-v0.1.0-rc.2.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.0-rc.3.schema.json](dsh-v0.1.0-rc.3.schema.json) |
