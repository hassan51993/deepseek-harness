---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.0-rc.6."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.0-rc.6

[English](dsh-v0.1.0-rc.6.md) | العربية
...
|---|---|
| وسم المصدر | `dsh-v0.1.0-rc.6` |
| تاريخ المصدر | 2026-08-13T11:56:40.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.1.0-rc.5](dsh-v0.1.0-rc.5.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.0-rc.6.schema.json](dsh-v0.1.0-rc.6.schema.json) |
