---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.3-alpha.1."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.3-alpha.1

[English](dsh-v0.1.3-alpha.1.md) | العربية

## الملخص

يتقدّم إصدارُ الكاتب من 0 إلى 2 عبر هذه الوسوم: فترويسةُ JSONL تستبدل seedLength بالحقل المطلوب isSeeded، ويكتسب `session/end-seed` الحقلَ الاختياري inherited. ويُحذف `assistant/chunk`، ويُضاف `assistant/attempt`، ويكتسب `assistant/message` مصفوفةَ stream مطلوبة. وتتقدّم إصداراتُ حمولات أحداث الفرق من 1 إلى 2، مع تغييرات في أنواع المحتوى المشتركة وفي البيانات الوصفية الاختيارية capturedFormatVersion وsessionFormatVersion.
...
|---|---|
| وسم المصدر | `dsh-v0.1.3-alpha.1` |
| تاريخ المصدر | 2026-09-04T09:16:23.000Z |
| سجل الإصدار | كائن الإصدار موجود. |
| الإصدار السابق | [dsh-v0.1.2-rc.1](dsh-v0.1.2-rc.1.ar.md) |
| إصدار كاتب Session | 2 |
| الجرد المعاد بناؤه | <!-- persistence-release-inventory:start -->54 جذرًا / 425 نوعًا<!-- persistence-release-inventory:end --> |
| هذه اللقطة | [dsh-v0.1.3-alpha.1.schema.json](dsh-v0.1.3-alpha.1.schema.json) |
...
اكتُشف 17 جذرًا متغيّرًا و25 فرقًا بنيويًا. والحدُّ الأدنى أدناه محسوبٌ بالقواعد الحالية للمقارنة وحدها؛ وهو لا يؤكّد امتثالًا تاريخيًا ولا صحةَ ترحيل ولا توافقًا في وقت التشغيل.
