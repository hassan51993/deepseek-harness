---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.2-rc.1."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.2-rc.1
...
|---|---|
| وسم المصدر | `dsh-v0.1.2-rc.1` |
| تاريخ المصدر | 2026-09-03T02:35:15.000Z |
| سجل الإصدار | كائن الإصدار موجود. |
| الإصدار السابق | [dsh-v0.1.2-alpha.5](dsh-v0.1.2-alpha.5.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.2-rc.1.schema.json](dsh-v0.1.2-rc.1.schema.json) |
