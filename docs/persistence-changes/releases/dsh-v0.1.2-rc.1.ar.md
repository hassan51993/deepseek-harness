---
description: "عودة تتبع dsh-v0.1.2-rc.1 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.1.2-rc.1

[English](dsh-v0.1.2-rc.1.md) | العربية
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.1.2-rc.1` |
| شفرة المصدر يوم مدة | 2026-09-03T02:35:15.000Z |
| إرسال سطر سجل | لديه release كائن. |
| قبل واحد إصدار | [dsh-v0.1.2-alpha.5](dsh-v0.1.2-alpha.5.ar.md) |
...
| هذا بند لقطة | [dsh-v0.1.2-rc.1.schema.json](dsh-v0.1.2-rc.1.schema.json) |
