---
description: "عودة تتبع dsh-v0.1.2-alpha.2 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.1.2-alpha.2

[English](dsh-v0.1.2-alpha.2.md) | العربية

## عام وصف

حدث معلومة غلاف استعادة اختياري حقل ignorable. كتابة صيغة ما زال لـ 0.
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.1.2-alpha.2` |
| شفرة المصدر يوم مدة | 2026-08-30T13:37:53.000Z |
| إرسال سطر سجل | لديه release كائن. |
| قبل واحد إصدار | [dsh-v0.1.2-alpha.1](dsh-v0.1.2-alpha.1.ar.md) |
...
| هذا بند لقطة | [dsh-v0.1.2-alpha.2.schema.json](dsh-v0.1.2-alpha.2.schema.json) |
...
فحص قياس إلى 52 عدد أصل نوع تغير،52 بند بنية فرق مختلف. تحت جدول الأكثر منخفض اشتراط حسب حالي قاعدة حساب حساب، فقط لأجل مقارنة مقارنة؛ لا يمثل قديم إصدار سبق التزام حراسة هذه قاعدة، أيضا لا إثبات ترحيل أو وقت التشغيل توافق صفة.
