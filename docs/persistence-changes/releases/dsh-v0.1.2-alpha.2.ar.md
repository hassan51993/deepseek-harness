---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.2-alpha.2."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.2-alpha.2

[English](dsh-v0.1.2-alpha.2.md) | العربية

## الملخص

يعيد المغلّفُ الحقلَ الاختياري ignorable. ويبقى إصدار الكاتب 0.
...
|---|---|
| وسم المصدر | `dsh-v0.1.2-alpha.2` |
| تاريخ المصدر | 2026-08-30T13:37:53.000Z |
| سجل الإصدار | كائن الإصدار موجود. |
| الإصدار السابق | [dsh-v0.1.2-alpha.1](dsh-v0.1.2-alpha.1.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.2-alpha.2.schema.json](dsh-v0.1.2-alpha.2.schema.json) |
...
اكتُشف 52 جذرًا متغيّرًا و52 فرقًا بنيويًا. والحدُّ الأدنى أدناه محسوبٌ بالقواعد الحالية للمقارنة وحدها؛ وهو لا يؤكّد امتثالًا تاريخيًا ولا صحةَ ترحيل ولا توافقًا في وقت التشغيل.
