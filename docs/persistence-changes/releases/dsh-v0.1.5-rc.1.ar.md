---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.5-rc.1."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.5-rc.1

[English](dsh-v0.1.5-rc.1.md) | العربية

## الملخص

تطابق كلُّ بصمات جذور الحفظ الدائم المعاد بناؤها وسمَ alpha أو rc السابق. ويبقى إصدار الكاتب 3.
...
|---|---|
| وسم المصدر | `dsh-v0.1.5-rc.1` |
| تاريخ المصدر | 2026-09-10T01:36:48.000Z |
| سجل الإصدار | كائن الإصدار موجود. |
| الإصدار السابق | [dsh-v0.1.5-alpha.2](dsh-v0.1.5-alpha.2.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.5-rc.1.schema.json](dsh-v0.1.5-rc.1.schema.json) |
