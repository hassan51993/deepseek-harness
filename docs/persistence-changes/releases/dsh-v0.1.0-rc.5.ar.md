---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.0-rc.5."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.0-rc.5

[English](dsh-v0.1.0-rc.5.md) | العربية
...
|---|---|
| وسم المصدر | `dsh-v0.1.0-rc.5` |
| تاريخ المصدر | 2026-08-13T11:38:46.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.1.0-rc.3](dsh-v0.1.0-rc.3.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.0-rc.5.schema.json](dsh-v0.1.0-rc.5.schema.json) |
