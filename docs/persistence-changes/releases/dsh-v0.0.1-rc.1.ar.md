---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.0.1-rc.1."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.0.1-rc.1

[English](dsh-v0.0.1-rc.1.md) | العربية

## الملخص

هذا أقدمُ وسم alpha أو rc متاح في DSH، وهو يُنشئ خطَّ الأساس التاريخي: 42 جذرَ حفظ دائم وإصدارَ كاتب 0.
...
|---|---|
| وسم المصدر | `dsh-v0.0.1-rc.1` |
| تاريخ المصدر | 2026-08-10T19:25:09.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | Earliest available prerelease tag; no earlier comparison input. |
| إصدار كاتب Session | 0 |
| الجرد المعاد بناؤه | <!-- persistence-release-inventory:start -->42 جذرًا / 341 نوعًا<!-- persistence-release-inventory:end --> |
| هذه اللقطة | [dsh-v0.0.1-rc.1.schema.json](dsh-v0.0.1-rc.1.schema.json) |
