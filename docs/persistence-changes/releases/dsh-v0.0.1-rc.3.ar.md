---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.0.1-rc.3."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.0.1-rc.3

[English](dsh-v0.0.1-rc.3.md) | العربية

## الملخص

تصير مفاتيحُ أحداث `compact/*` الأربعة `compaction/*`؛ ويصير نوعُ مصدر رسالة المستخدم workspace-instructions هو agent-instructions، وتصير لهجةُ الخطاف claude هي claude-code. وتقع تغييراتُ القيم الحرفية ومفاتيح الأحداث هذه بينما يبقى إصدار الكاتب 0.
...
|---|---|
| وسم المصدر | `dsh-v0.0.1-rc.3` |
| تاريخ المصدر | 2026-08-12T20:18:26.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.0.1-rc.2](dsh-v0.0.1-rc.2.ar.md) |
| إصدار كاتب Session | 0 |
| الجرد المعاد بناؤه | <!-- persistence-release-inventory:start -->47 جذرًا / 374 نوعًا<!-- persistence-release-inventory:end --> |
| هذه اللقطة | [dsh-v0.0.1-rc.3.schema.json](dsh-v0.0.1-rc.3.schema.json) |
...
اكتُشف 12 جذرًا متغيّرًا و12 فرقًا بنيويًا. والحدُّ الأدنى أدناه محسوبٌ بالقواعد الحالية للمقارنة وحدها؛ وهو لا يؤكّد امتثالًا تاريخيًا ولا صحةَ ترحيل ولا توافقًا في وقت التشغيل.
