---
description: "عودة تتبع dsh-v0.1.1-rc.2 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.1.1-rc.2

[English](dsh-v0.1.1-rc.2.md) | العربية

## عام وصف

permission/preset حذف origin؛ مرفق عنصر سجل إضافة جديدة اختياري حقل originalDimensions، أثر مرجع مرفق عنصر رسالة و أداة تحميل حمل. كتابة صيغة ما زال لـ 0.
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.1.1-rc.2` |
| شفرة المصدر يوم مدة | 2026-08-21T12:03:37.000Z |
| إرسال سطر سجل | لديه release كائن. |
| قبل واحد إصدار | [dsh-v0.1.1-rc.1](dsh-v0.1.1-rc.1.ar.md) |
| Session كتابة إصدار | 0 |
| كامل إعادة بناء بيان | <!-- persistence-release-inventory:start -->51 عدد أصل نوع / 404 نوع نوع<!-- persistence-release-inventory:end --> |
| هذا بند لقطة | [dsh-v0.1.1-rc.2.schema.json](dsh-v0.1.1-rc.2.schema.json) |
...
فحص قياس إلى 10 عدد أصل نوع تغير،11 بند بنية فرق مختلف. تحت جدول الأكثر منخفض اشتراط حسب حالي قاعدة حساب حساب، فقط لأجل مقارنة مقارنة؛ لا يمثل قديم إصدار سبق التزام حراسة هذه قاعدة، أيضا لا إثبات ترحيل أو وقت التشغيل توافق صفة.
