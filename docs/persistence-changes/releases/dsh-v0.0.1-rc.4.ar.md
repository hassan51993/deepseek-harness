---
description: "عودة تتبع dsh-v0.0.1-rc.4 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.0.1-rc.4
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.0.1-rc.4` |
| شفرة المصدر يوم مدة | 2026-08-12T21:29:23.000Z |
| إرسال سطر سجل | فقط لديه tag، لا يوجد release كائن. |
| قبل واحد إصدار | [dsh-v0.0.1-rc.3](dsh-v0.0.1-rc.3.ar.md) |
...
| هذا بند لقطة | [dsh-v0.0.1-rc.4.schema.json](dsh-v0.0.1-rc.4.schema.json) |
