---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.0-rc.1."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.0-rc.1

[English](dsh-v0.1.0-rc.1.md) | العربية
...
|---|---|
| وسم المصدر | `dsh-v0.1.0-rc.1` |
| تاريخ المصدر | 2026-08-13T08:51:36.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.0.1-rc.5](dsh-v0.0.1-rc.5.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.0-rc.1.schema.json](dsh-v0.1.0-rc.1.schema.json) |
