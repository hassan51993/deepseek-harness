---
description: "عودة تتبع dsh-v0.1.0-rc.6 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.1.0-rc.6
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.1.0-rc.6` |
| شفرة المصدر يوم مدة | 2026-08-13T11:56:40.000Z |
| إرسال سطر سجل | فقط لديه tag، لا يوجد release كائن. |
| قبل واحد إصدار | [dsh-v0.1.0-rc.5](dsh-v0.1.0-rc.5.zh.md) |
...
| هذا بند لقطة | [dsh-v0.1.0-rc.6.schema.json](dsh-v0.1.0-rc.6.schema.json) |
