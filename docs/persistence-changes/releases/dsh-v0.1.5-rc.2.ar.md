---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.5-rc.2."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.5-rc.2
...
|---|---|
| وسم المصدر | `dsh-v0.1.5-rc.2` |
| تاريخ المصدر | 2026-09-10T13:50:19.000Z |
| سجل الإصدار | كائن الإصدار موجود. |
| الإصدار السابق | [dsh-v0.1.5-rc.1](dsh-v0.1.5-rc.1.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.5-rc.2.schema.json](dsh-v0.1.5-rc.2.schema.json) |
