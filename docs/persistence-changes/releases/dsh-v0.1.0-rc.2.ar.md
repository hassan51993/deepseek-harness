---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.0-rc.2."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.0-rc.2

[English](dsh-v0.1.0-rc.2.md) | العربية
...
|---|---|
| وسم المصدر | `dsh-v0.1.0-rc.2` |
| تاريخ المصدر | 2026-08-13T09:23:52.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.1.0-rc.1](dsh-v0.1.0-rc.1.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.0-rc.2.schema.json](dsh-v0.1.0-rc.2.schema.json) |
