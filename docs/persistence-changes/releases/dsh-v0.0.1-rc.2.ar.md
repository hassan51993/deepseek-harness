---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.0.1-rc.2."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.0.1-rc.2

[English](dsh-v0.0.1-rc.2.md) | العربية

## الملخص

يكتسب مغلّفُ الأحداث الحقلَ الاختياري ignorable، ويُضاف `schedule/change` مع أربعة أحداث لسير عمل الأدوات. ويبقى إصدار الكاتب 0.
...
|---|---|
| وسم المصدر | `dsh-v0.0.1-rc.2` |
| تاريخ المصدر | 2026-08-11T15:04:55.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.0.1-rc.1](dsh-v0.0.1-rc.1.ar.md) |
...
| هذه اللقطة | [dsh-v0.0.1-rc.2.schema.json](dsh-v0.0.1-rc.2.schema.json) |
...
اكتُشف 45 جذرًا متغيّرًا و48 فرقًا بنيويًا. والحدُّ الأدنى أدناه محسوبٌ بالقواعد الحالية للمقارنة وحدها؛ وهو لا يؤكّد امتثالًا تاريخيًا ولا صحةَ ترحيل ولا توافقًا في وقت التشغيل.
