---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.0.1-rc.5."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.0.1-rc.5

[English](dsh-v0.0.1-rc.5.md) | العربية
...
|---|---|
| وسم المصدر | `dsh-v0.0.1-rc.5` |
| تاريخ المصدر | 2026-08-12T22:18:58.000Z |
| سجل الإصدار | وسمٌ فقط؛ لا كائن إصدار. |
| الإصدار السابق | [dsh-v0.0.1-rc.4](dsh-v0.0.1-rc.4.ar.md) |
...
| هذه اللقطة | [dsh-v0.0.1-rc.5.schema.json](dsh-v0.0.1-rc.5.schema.json) |
