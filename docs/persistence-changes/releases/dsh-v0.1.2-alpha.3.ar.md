---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.2-alpha.3."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.2-alpha.3

[English](dsh-v0.1.2-alpha.3.md) | العربية

## الملخص

تطابق كلُّ بصمات جذور الحفظ الدائم المعاد بناؤها وسمَ alpha السابق. ويبقى إصدار الكاتب 0.
...
|---|---|
| وسم المصدر | `dsh-v0.1.2-alpha.3` |
| تاريخ المصدر | 2026-08-31T15:53:17.000Z |
| سجل الإصدار | كائن الإصدار موجود. |
| الإصدار السابق | [dsh-v0.1.2-alpha.2](dsh-v0.1.2-alpha.2.ar.md) |
...
| هذه اللقطة | [dsh-v0.1.2-alpha.3.schema.json](dsh-v0.1.2-alpha.3.schema.json) |
