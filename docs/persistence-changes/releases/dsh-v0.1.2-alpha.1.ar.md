---
description: "عودة تتبع dsh-v0.1.2-alpha.1 قد إعلان Session حفظ دائم نوع و متبادل مجاور إصدار تغير."
kind: persistence-release
---

# حفظ دائم إصدار عودة تتبع: dsh-v0.1.2-alpha.1

[English](dsh-v0.1.2-alpha.1.md) | العربية

## عام وصف

حدث معلومة غلاف حذف ignorable،request/header إضافة جديدة اختياري حقل startsSeries و سبب قيمة series، و إضافة جديدة نموذج اختيار، فرعي Agent نموذج سياسة و إلقاء تمرير تأكيد حدث. كل إدارة وجود هذه بنية تغير، كتابة صيغة ما زال لـ 0.
...
| مشروع | سجل قيمة |
|---|---|
| شفرة المصدر tag | `dsh-v0.1.2-alpha.1` |
| شفرة المصدر يوم مدة | 2026-08-27T16:57:43.000Z |
| إرسال سطر سجل | لديه release كائن. |
| قبل واحد إصدار | [dsh-v0.1.1-rc.2](dsh-v0.1.1-rc.2.ar.md) |
...
| هذا بند لقطة | [dsh-v0.1.2-alpha.1.schema.json](dsh-v0.1.2-alpha.1.schema.json) |
...
فحص قياس إلى 52 عدد أصل نوع تغير،61 بند بنية فرق مختلف. تحت جدول الأكثر منخفض اشتراط حسب حالي قاعدة حساب حساب، فقط لأجل مقارنة مقارنة؛ لا يمثل قديم إصدار سبق التزام حراسة هذه قاعدة، أيضا لا إثبات ترحيل أو وقت التشغيل توافق صفة.
