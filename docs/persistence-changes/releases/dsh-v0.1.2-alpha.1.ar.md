---
description: "أنواع حفظ الجلسة الدائم الاسترجاعية وتغييرات الإصدارات المتجاورة للوسم dsh-v0.1.2-alpha.1."
kind: persistence-release
---

# إصدار الحفظ الدائم: dsh-v0.1.2-alpha.1

[English](dsh-v0.1.2-alpha.1.md) | العربية

## الملخص

يحذف المغلّفُ الحقلَ ignorable، ويكتسب `request/header` الحقلَ الاختياري startsSeries والسببَ series، وتُضاف أحداثُ اختيار النموذج وسياسةِ نموذج subagent وقبولِ التسليم. ويبقى إصدار الكاتب 0 رغم هذه التغييرات البنيوية.
...
|---|---|
| وسم المصدر | `dsh-v0.1.2-alpha.1` |
| تاريخ المصدر | 2026-08-27T16:57:43.000Z |
| سجل الإصدار | كائن الإصدار موجود. |
| الإصدار السابق | [dsh-v0.1.1-rc.2](dsh-v0.1.1-rc.2.ar.md) |
| إصدار كاتب Session | 0 |
| الجرد المعاد بناؤه | <!-- persistence-release-inventory:start -->54 جذرًا / 417 نوعًا<!-- persistence-release-inventory:end --> |
| هذه اللقطة | [dsh-v0.1.2-alpha.1.schema.json](dsh-v0.1.2-alpha.1.schema.json) |
...
اكتُشف 52 جذرًا متغيّرًا و61 فرقًا بنيويًا. والحدُّ الأدنى أدناه محسوبٌ بالقواعد الحالية للمقارنة وحدها؛ وهو لا يؤكّد امتثالًا تاريخيًا ولا صحةَ ترحيل ولا توافقًا في وقت التشغيل.
