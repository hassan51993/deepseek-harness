...
مصدر لـ قد إصدار tag `dsh-v0.1.3-alpha.2`، ذلك كتابة جهاز معتاد كمية لـ 2.[tag سجل](../releases/dsh-v0.1.3-alpha.2.ar.md) شرح متبادل مجاور إصدار بين تغير. هذا كامل دليل معا يتضمن لم تغير أصل نوع و هذا tag تغير أصل نوع.
...
[V2 codec](../../../packages/session/session-format-v1-to-v2/src/codec.ts) مسؤول كل سطر واحد حدث تحرير رمز، نطاق تحرير رمز مصدر مرجع، و من `session/end-seed` علامة دفع توجيه وراثة قطع نقطة.[V2 إلى V3 مواصفة](../../../packages/session/session-format-v2-to-v3/README.ar.md#v2-to-v3-specification) مسؤول نظام رسالة إدراج دخول،PTC حدث اسم و مواصفة معلومة غلاف تحويل.
...
هذا فحص فقط استخدام هذا عمل شجرة تحقق مباشر إلى حالي كتابة جهاز كل صيغة،schema كامل صفة، مزدوج لغة إعلان و توليد جدول إطار. هو لن إعادة تشغيل تاريخ تطبيق، أيضا لا تأكيد قيام ترحيل أمان صفة. صيانة قاعدة مشاركة رؤية[صيغة بحث جذب](README.ar.md) ، حالي إعلان مشاركة رؤية[حالي دليل](../../persistence-catalog.ar.md).
