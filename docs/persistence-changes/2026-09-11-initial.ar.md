...
# خط الأساس الأول لأنواع الحفظ الدائم

[English](2026-09-11-initial.md) | العربية

## الملخص

يسجّل خطُّ الأساس هذا جردَ أنواع الحفظ الدائم الذي يعلنه المصدرُ الحالي كاملًا، ويعطي الانتقالاتِ اللاحقة نقطةَ بدء مخزَّنة في هذه الشجرة.
...
يهيّئ هذا السجلُّ تاريخَ الأنواع بلا ادّعاء علاقات بصيغ أسبق وبلا تغيير إصدار كاتب الجلسة ولا سلوكِ وقت التشغيل. ويبدأ كل جذر بلا سلف ويحتفظ بـ schema الموحَّد كاملًا؛ وتشير سجلاتُ الخلف إلى schema «بعد» عنده.

<a id="verification"></a>
## التحقق

شُغّل `pnpm exec tsx scripts/gen-persistence-catalog.ts` لتوليد الجرد الحالي، و`pnpm run persistence-changes --baseline 2026-09-11-initial` لإنشاء خط الأساس هذا ولقطةِ schema الخاصة به.
