...
سحب كائن خدمة صنف——نشر وقت ينبغي تعديل لـ تحميل أداة جسم تنفيذ حزمة (مشاركة رؤية[قدرة seam](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)).
