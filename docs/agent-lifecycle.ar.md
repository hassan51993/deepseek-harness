...
هذا وقت ترتيب رسم هو [architecture.md](architecture.ar.md#turn-flow) إعداد طقم رسم عرض. حمل دائم إعادة تشغيل واقع حفظ في `session/event` في، فوري تحكم و حالة فإن حفظ في `agent/*` في.
