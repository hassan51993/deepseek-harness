...
const arabic: Record<keyof typeof english, string> = {
  ...
  historyIntro: '[صيغة مشاركة اعتبار](persistence-changes/historical-formats/README.ar.md) تغطية كل تاريخ Session صيغة.[تغيير سجل](persistence-changes/README.ar.md) عبر حفظ في هذا شفرة المصدر شجرة في لقطة تأكيد دقيق نوع تحويل. حسب وفق[مراجعة مسار](cookbook/reviewing-persistence-type-changes.ar.md) تصنيف و سجل تغيير. هذه فحص تغطية قد إعلان نوع بنية؛ لا نفاذ واضح تحميل حمل داخلي محتوى و لم تغيير نوع سلوك تغيير لا في فحص نطاق داخل.',
