...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  { file: 'docs/event-producer-consumer.ar.md', upstream: ['cordis'] },
  { file: 'docs/subsystems/extensions.md', upstream: ['cordis'] },
  { file: 'docs/subsystems/extensions.ar.md', upstream: ['cordis'] },
...
/** Generated descriptor/codec contribution with no shared runtime identity. */`,
  ...
  {
    id: 'vendoring-cookbook-tree-comment-ar',
    file: 'docs/cookbook/adding-a-vendored-package.ar.md',
    find: '  package.json     # from upstream; set "private": true, keep name/exports/type',
    replace: '  package.json     # from upstream; rescope the name, keep exports/type (publishable release member, no private flag)',
    expect: 1,
  },
  ...
  {
    id: 'vendoring-cookbook-name-invariant-ar',
    file: 'docs/cookbook/adding-a-vendored-package.ar.md',
    find: 'إبقاء فوق تنقل `name`/`version`/`exports`/`type`',
    replace: 'تعديل كتابة `name` scope([خريطة](../rescope.ar.md)) ، إبقاء فوق تنقل `exports`/`type`',
    expect: 1,
  },
  {
...
export function isRescopeExcluded(file: string): boolean {
  ...
  if (file === 'docs/rescope.md' || file === 'docs/rescope.ar.md') return true
