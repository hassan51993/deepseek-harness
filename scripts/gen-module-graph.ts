...
export function renderModuleGraph(pkgs: readonly Pkg[], locale: Locale): string {
  ...
  return [
    ...
    '',
    chinese ? '# مشترك نسخة اعتماد علاقة رسم' : '# Shared-instance dependency graph',
    '',
    ...(chinese ? ['[English](module-graph.md) | العربية', ''] : []),
    chinese
    ...
    '```',
    '',
    chinese ? '| حزمة | قسم مجموعة | Peer اعتماد |' : '| Package | Group | Peer dependencies |',
    '| --- | --- | --- |',
    ...rows,
    '',
  ].join('\n')
