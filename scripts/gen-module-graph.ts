...
export function renderModuleGraph(pkgs: readonly Pkg[], locale: Locale): string {
  ...
  return [
    ...
    '',
    arabic ? '# مشترك نسخة اعتماد علاقة رسم' : '# Shared-instance dependency graph',
    '',
    ...(arabic ? ['[English](module-graph.md) | العربية', ''] : []),
    arabic
    ...
    '```',
    '',
    arabic ? '| حزمة | قسم مجموعة | Peer اعتماد |' : '| Package | Group | Peer dependencies |',
    '| --- | --- | --- |',
    ...rows,
    '',
  ].join('\n')
