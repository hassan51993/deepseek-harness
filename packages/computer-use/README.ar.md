...
|---|---|---|
| [`computer-use`](computer-use/README.ar.md) | حسب اسم وحيد احتلال تسجيل مزود | `ctx.computerUse` |

<a id="related-documentation"></a>
## متبادل صلة وثيقة

- [حساب حساب آلة عملية](../../docs/subsystems/computer-use.ar.md) — قدرة ملكية و مزود اختيار.
- [فعلي تحقق صفة حزمة](../experimental/README.ar.md) — Cua Driver MCP و أصلي مزود.
