...
export const ar = {
  ...
  'toolbar.collapseTurns': 'طي كل جولة',
  'toolbar.calls': 'استدعاء',
  'toolbar.expandCalls': 'توسيع كل استدعاء',
  'toolbar.collapseCalls': 'طي كل استدعاء',
  ...
  'record.toolCallOnly': '(فقط استدعاء الأداة)',
  ...
  'record.tools': 'أداة',
  'block.openSummary': 'فتح رقم {index} عدد كتلة استدعاء الأداة عام وصف',
  'block.openSummaryTitle': 'فتح استدعاء الأداة عام وصف',
  'block.label': 'كتلة #{index} {type}',
  'history.loadingTrajectory': 'جارٍ تحميل مسار أثر…',
  'history.loadingEarlier': 'جارٍ تحميل أكثر مبكر تاريخ…',
  'history.loadingEarlierAria': 'جارٍ تحميل أكثر مبكر تاريخ…',
  ...
  'request.collapsedSummary': 'قد طي{kind}عام وصف،{summary}',
  ...
  'summary.toolCalls.one': '{count} عدد استدعاء الأداة',
  'summary.toolCalls.other': '{count} عدد استدعاء الأداة',
  ...
  'details.model': 'نموذج',
  'details.toolCalls': 'استدعاء الأداة',
  'details.subtoolCalls': 'فرعي استدعاء الأداة',
  'details.error': 'خطأ',
  'details.failure.auth': 'API مفتاح بلا فاعلية',
  'details.retry': 'إعادة محاولة',
  'details.scheduled': 'قد خطة',
  ...
  'details.toolCall': 'استدعاء الأداة',
  ...
  'layout.compacting': 'جارٍ ضغط سياق…',
  'layout.compactionFailed': 'سياق ضغط فشل',
  'layout.compacted': 'سياق قد ضغط',
  'layout.toolCallOnly': 'فقط استدعاء الأداة',
