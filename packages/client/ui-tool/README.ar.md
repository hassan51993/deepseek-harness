...
استدعاء الأداة في محادثة في عرض لـ بطاقة: واحد أصل استدعاء شجرة حمل ذلك تضمين طقم فرعي استدعاء، كل أصل فرعي استدعاء من الذي تابع عرض تصيير. مستخدم يرى تشغيل في، نجاح، فشل و في قطع حالة، هذه حالة فقط قدوم ذاتي تجميد ربط استدعاء/نتيجة مقتطعة، و يمكن عبر مضيف عودة ضبط فتح ملف أو فحص استدعاء.
...
بلا. هذا حزمة هو متصفح طرف أداة عرض طبقة، فقط تصيير قد سجل استدعاء الأداة، لا تغيير نموذج سياق.
