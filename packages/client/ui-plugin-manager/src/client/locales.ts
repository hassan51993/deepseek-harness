...
export const zh = {
  ...
  builtinAgentTeamWebDescription: 'في متصفح في فحص نظر مجموعة طابور عضو، مهمة نظر لوح و عضو جلسة.',
  builtinAutoReviewTitle: 'تلقائي تخويل مراجعة فحص',
  builtinAutoReviewDescription: 'توفير تلقائي مراجعة فحص إذن نمط، من نموذج في كل مرة أداة استدعاء قبل حكم قطع هل تخويل.',
  ...
  installGuideHide: 'استلام بدء جذب توجيه',
  ...
  installProblemNetwork: 'لا يمكن اتصال إضافة مصدر، طلب فحص شبكة شبكة بعد إعادة محاولة',
  ...
  installStarting: 'صحيح في دقيق تجهيز تثبيت…',
  installCancelling: 'صحيح في إيقاف تثبيت…',
  installApplying: 'صحيح في تطبيق إعداد، طلب قليلا انتظار…',
  ...
  installDetailsShow: 'فحص نظر تثبيت تفصيل حال',
  installDetailsHide: 'استلام بدء تثبيت تفصيل حال',
  ...
  installFailureNetwork: 'شبكة شبكة اتصال فشل',
  ...
  terminalFailed: 'فشل',
  terminalDone: 'قد إتمام',
  terminalCopy: 'نسخ',
  terminalCopied: 'نسخ نجاح',
  terminalNoOutput: 'بلا إخراج',
  terminalCollapseAria: 'استلام بدء إخراج',
  terminalCollapse: 'استلام بدء',
  ...
  reasonStopProfile: 'هذا عدد profile لا يوجد تفعيل HMR، صحيح في استخدام حزمة يلزم إيقاف بعد استخدام dsh plugin إزالة',
