...
describe('multibyte content', () => {
  const CJK_DOC = [
    '# عنوان 🎉',
    '',
    'هذا هو واحد مقطع يتضمن **إضافة خشن**،`سطر داخل شفرة` و جدول حال 😀🚀 العربية مقطع سقوط.',
    '',
    '- قائمة بند واحد ✅',
    '- قائمة بند اثنان',
    '',
    '> مرجع واحد سطر,حمل جدول حال 🐟',
    '',
    '```',
    'العربية شفرة 🎯',
    '```',
    ...
    '| درع | ثان |',
    '',
    'ربط ذيل مقطع سقوط,كاف كاف كثير كتلة يجعل قبل وجه الكل تجميد ربط.🌊',
  ].join('\n')
