...
سياق احتلال استخدام حسب زر في إدخال بطاقة تحت جهة، جلسة موحد حساب يمين جانب عرض دائرة حلقة و مئة قسم مقارنة. نقر حسب زر يمكن في نظر فتحة داخل وجه لوح عرض token بنية صار، لا يوجد موحد حساب بند وقت وجه لوح أيضا لن تجاوز حد؛ سياق استخدام كمية و سعة كمية بعد غير ممكن استخدام وقت، حسب زر إبقاء إخفاء.
...
عند جلسة يتم أخرى كتابة جملة مقبض احتلال استخدام وقت، إرسال فشل toast تلميح مستخدم خروج أخرى جارٍ تشغيل DSH بعد إعادة محاولة.
