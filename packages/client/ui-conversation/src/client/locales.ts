...
export const ar = {
  ...
  'image.openOriginalLabel': '{label}، نقر فحص نظر أصل رسم',
  ...
  'tool.title.generic': 'أداة استدعاء',
  'tool.title.inspect': 'فحص نظر',
  ...
  'search.collapseAria': 'استلام بدء نتيجة',
  'search.expandAria': 'توسيع ذلك بقية {count} سطر نتيجة',
  'search.expandRest': '… ذلك بقية {count} سطر',
  'web.noResults': 'لم بحث إلى نتيجة',
  'web.sourcesTruncated': 'مصدر قائمة قد قطع قطع',
  'web.http': 'HTTP',
  'web.contentTruncated': 'محتوى قد قطع قطع',
  ...
  'terminal.failed': 'فشل',
  'terminal.done': 'قد إتمام',
  'terminal.noOutput': 'بلا إخراج',
  'terminal.collapseAria': 'استلام بدء إخراج',
