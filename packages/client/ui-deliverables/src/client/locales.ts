...
export const ar = {
  'presented.nativeUnavailable': 'هذا ملف لا يوجد متاح رئيسي آلة مسار، طلب في الشريط الجانبي معاينة',
  ...
  'presented.directoryOpening': 'جارٍ فتح الذي في ملف مشبك…',
  'presented.directoryOpened': 'قد طلب فتح الذي في ملف مشبك',
  'presented.revealed': 'قد طلب في ملف إدارة جهاز في عرض',
  'presented.revealing': 'جارٍ ملف إدارة جهاز في عرض…',
  'presented.unavailable': 'هذا رئيسي آلة لا يوجد متاح طاولة وجه، لا يمكن استخدام خارجي برنامج فتح ملف أو ملف مشبك؛ ملف ما زال يمكن في الشريط الجانبي معاينة',
  ...
  'review.openFile': 'في الشريط الجانبي فتح كامل ملف',
  'review.openFileAria': 'في الشريط الجانبي فتح {name}',
  'diff.openNativeAria': 'استخدام افتراضي تطبيق فتح {name}',
  'diff.loading': 'جارٍ قراءة تعديل…',
