...
import {
  accessEn, accessAr, en, PERMISSION_ACCESS_NS, ar,
} from './locales.ts'
import {
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(
    () => ctx.locale.register(PERMISSION_ACCESS_NS, { ar: accessAr, en: accessEn }),
  ...
  ctx.effect(() => ctx.locale.register('settings.permission', { ar, en }), 'ui-permission: settings row dictionaries')
