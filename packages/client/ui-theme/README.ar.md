...
- [ui-layout](../ui-layout/README.ar.md)——تطبيق تحليل بعد رئيسي عنوان لقطة عرض تحويل جهاز.
- [ui-sidebar](../ui-sidebar/README.ar.md)——تمرير بند إعادة ربط اتفاق مستهلك.
- [ui-conversation](../ui-conversation/README.ar.md)——لـ composer مقعد موضع إزالة استهلاك `--dsh-scrollbar-width` مستهلك.
- [Web مثال صيغة](../../../docs/web-styling.ar.md)——Web عميل مكون مرجعي مثال صيغة قاعدة.
- [Host دعم دعم انحراف جيد](../../../.agents/notes/implemented/bug-fix/2026-08-06-host-backed-web-preferences.ar.md)——حفظ دائم حد قرار.
