...
export const ar = {
  ...
  'dialog.title': 'إيداع ملاحظات',
  'dialog.categories': 'ملاحظات تصنيف',
  'dialog.detail': 'ملاحظات تفصيل حال',
  'dialog.hint': 'ملء كتابة تفصيل حال بـ مساعدة أنا جمع تعديل دخول تجربة، إيداع محتوى سوف يشمل حالي محادثة سجل',
  ...
  'category.other': 'أخرى',
  'toast.recorded': 'شعور شكر أنت ملاحظات',
  'error.conflict': 'هذا بند ملاحظات قد في آخر موضع تعديل، قد عرض الأكثر جديد حالة',
  'error.load': 'ملاحظات حالة تحميل فشل',
  'error.generic': 'ملاحظات حفظ فشل',
