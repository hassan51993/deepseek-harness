...
export const ar = {
  'chip.label': 'Plan',
  'preview.title': 'خطة',
  'preview.document': 'خطة · Markdown',
  'preview.action': 'فتح',
  'preview.open': 'في الشريط الجانبي فتح خطة',
  'preview.full': 'عرض كل نص',
  'preview.openNamed': 'فتح خطة:{title}',
  'preview.loading': 'جارٍ قراءة خطة…',
  'preview.failed': 'لا يمكن قراءة خطة',
  'preview.invalidAddress': 'خطة عنوان بلا فاعلية',
  'preview.historyUnavailable': 'لا يمكن قراءة جلسة تاريخ',
  'preview.notFound': 'لم بحث إلى هذا نسخة خطة',
  'preview.unavailable': 'خطة معاينة غير ممكن استخدام',
  'preview.expired': 'مؤقت خطة معاينة قد بطلان، طلب من ما زال في انتظار مراجعة دفعة بطاقة إعادة فتح.',
