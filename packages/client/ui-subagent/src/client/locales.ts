...
export const ar = {
  ...
  'duration.exactDays': '{days}يوم{hours}ساعة{minutes}قسم{seconds}ثانية',
  ...
  'loading.label': 'جارٍ تحميل فرعي بديل إدارة…',
  'loading.aria': 'جارٍ تحميل فرعي بديل إدارة',
  'load.error': 'لا يمكن تحميل فرعي بديل إدارة',
  'retry': 'إعادة محاولة',
  'mode.oneShot': 'مرة صفة',
  'mode.continuable': 'يمكن متابعة',
  'activity.running': 'جارٍ تشغيل',
  'activity.inactive': 'حالي لم تشغيل',
  'branch.collapse': 'طي {label} تحت درجة فرعي بديل إدارة',
  ...
  'count.running.one': '{count} عدد فرعي بديل إدارة، جارٍ تشغيل',
  'count.running.other': '{count} عدد فرعي بديل إدارة، جارٍ تشغيل',
  'switcher.aria': 'تبديل فرعي بديل إدارة:{title}',
  'tree.aria': 'فرعي بديل إدارة جلسة',
  'open.sidebar': 'في الشريط الجانبي فتح {label}',
  ...
  'readonly.oneShot.body': 'مرة صفة مهمة لا دعم حمل لاحق رسالة، يمكن في هذا داخل عرض كامل تنفيذ سجل.',
