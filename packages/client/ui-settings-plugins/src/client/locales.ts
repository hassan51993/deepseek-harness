...
export const ar: Record<PluginsSettingsLocaleKey, string> = {
  ...
  intro: 'عرض داخل وضع نشر إضافة قائمة',
  tabs: 'إضافة عرض',
  ...
  bashTimeoutMs: 'أمر مهلة (مللي ثانية)',
  ...
  agentLoopDescription: 'Agent مثل أي إرسال إرسال استدعاء الأداة.',
  agentLoopMaxParallel: 'و سطر استدعاء الأداة عدد',
  ...
  subagentModelSelectionChoose: 'فتح بدء بعد،Agent يمكن من تحت جهة تخويل نموذج في، لـ كل Subagent اختيار مزود، نموذج و دفع إدارة قوي درجة. فقط أثر جلسة جديدة.',
  subagentModelSelectionAllowed: 'Agent اختياري اختيار نموذج',
  subagentModelSelectionLoading: 'جارٍ تحميل نموذج…',
