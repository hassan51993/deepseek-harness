...
- **متصفح cookie لا حمل `Secure`**: حالي مع منتج توفير نقل طريقة هو loopback HTTP؛ إذا نشر مرور واضح نص شبكة كشف نفس authority،bearer cookie ممكن في نقل في تسرب كشف.
