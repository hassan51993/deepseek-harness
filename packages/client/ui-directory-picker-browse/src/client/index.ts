  ...
  ctx.effect(() => {
    ...
    const dictionaries: [locale: string, dict: Record<string, string>][] = [
      ['zh', {
        ...
        'browser.folderName': 'ملف مشبك اسم',
        'browser.createIn': 'في"{name}"في جديد بناء ملف مشبك',
        'browser.untitledFolder': 'لم تسمية ملف مشبك',
        'browser.create': 'إنشاء',
        'browser.cancel': 'إلغاء',
        'browser.open': 'فتح',
        'browser.editPath': 'تحرير مسار',
        'browser.loading': 'تحميل في…',
        'browser.truncated': 'ملف مشبك مرور كثير، فقط عرض فتح رأس جزء.',
        'browser.showHidden': 'عرض إخفاء ملف',
      }],
      ['en', {
