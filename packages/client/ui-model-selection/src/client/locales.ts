...
export const ar = {
  ...
  'trigger.loading': 'صحيح في تحميل نموذج…',
  ...
  'status.loading': 'صحيح في تحديث جديد نموذج قائمة…',
  'error.action': 'نموذج عملية فشل:{message}',
  'error.sessionInUse': 'حالي جلسة قد يتم احتلال استخدام، ممكن هو أخرى صحيح في تشغيل DSH توجيه يؤدي (مثل أخرى dsh web، طاولة وجه طرف) ، طلب خروج أخرى صحيح في تشغيل DSH بعد إعادة محاولة.',
