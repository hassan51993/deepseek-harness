...
describe('ui-settings-plugin-inventory browser plugin', () => {
  ...
  it('registers a localized tab without reading the Remote eagerly', async () => {
    ...
    b.locale.register('settings.agentPreset', 'ar', { presetStandardName: 'النمط العاديي' } as never)
    expect(injected.presetName({ id: 'standard', trust: 'system', isDefault: true, rows: [] })).toBe('النمط العاديي')
