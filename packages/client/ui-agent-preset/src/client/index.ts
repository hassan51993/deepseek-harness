...
import { en, ar, type AgentPresetSettingsKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register('settings.agentPreset', { ar, en }), 'ui-agent-preset: settings row dictionaries')
