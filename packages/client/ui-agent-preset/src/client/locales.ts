...
export const ar: Record<AgentPresetSettingsKey, string> = {
  ...
  view: 'عرض',
  presetStandardName: 'النمط المعياري',
  presetStandardDescription: 'وظيفة كامل تحرير رمز Agent، دعم حمل ملف تحرير،Shell، ملف و شبكة صفحة فحص بحث،Skills، خطة، هدف، فرعي بديل إدارة و سير العمل.',
  ...
  presetCordisDescription: 'لأجل إنشاء ذاتي تعريف Agent preset: أداة تجهيز النمط المعياري الكل قدرة، و توفير وقت التشغيل فحص، حفظ دائم إضافة إدارة و preset إنشاء عمل إشارة توجيه.',
  duplicate: 'نسخ',
  ...
  deleteDescription: 'مسبق ضبط دليل سوف يتم حذف. قد في ذلك فوق تشغيل جلسة لا تلقي أثر؛ جلسة جديدة سوف لا يمكن مجددا اختيار هو.',
  deleteConfirm: 'حذف',
  deleting: 'جارٍ حذف…',
  showPicker: 'سماح تبديلagentنمط',
  showPickerBeta: 'beta',
  showPickerDescription: 'فتح بدء بعد، جديد مهمة اختياري اختيار معيار،PTC، إنشاء صنع، أقصى بسيط و ذاتي تعريف نمط؛ إغلاق بعد موحد واحد استخدام افتراضي نمط (افتراضي لـ النمط المعياري، يمكن ذاتي تعريف). فقط أثر جديد مهمة.',
