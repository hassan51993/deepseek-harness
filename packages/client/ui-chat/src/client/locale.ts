...
export const ar = {
  ...
  'duration.milliseconds': '{milliseconds}مللي ثانية',
  ...
  'stats.dialog.toolTime': 'استدعاء الأداة استخدام وقت',
  ...
  'settings.transcript.description': 'تحكم اكتمل جولة مرور مسار محتوى',
  ...
  'message.context.recall.truncated': 'قد مقتطع',
  'message.compaction': 'سياق قد ضغط',
  'message.compaction.running': 'جارٍ ضغط…',
  'message.compaction.completed': 'قد ضغط {items} بند تاريخ سجل (نحو {tokens} tokens)',
  'message.compaction.expand': 'نقر عرض ضغط ملخص',
  ...
  'message.turnProcess.toolCalls.one': '{count} مرة استدعاء الأداة',
  'message.turnProcess.toolCalls.other': '{count} مرة استدعاء الأداة',
  ...
  'message.branchUnavailable': 'فقط يمكن من اكتمل جولة الأكثر بعد واحد بند رسالة فرع',
  'message.retry.active': 'جارٍ إعادة محاولة نموذج طلب',
  ...
  'message.maxTokens.hint': 'عودة جواب يتم مقتطع، قد لديه إخراج إبقاء في محادثة في. إرسال “متابعة” يمكن يجعل نموذج وصل حال إخراج.',
  ...
  'duration.hours': '{hours}ساعة{minutes}قسم{seconds}ثانية',
  ...
  'row.failed': 'فشل',
  'json.truncated': '… قد مقتطع، مشترك {total} محرف',
