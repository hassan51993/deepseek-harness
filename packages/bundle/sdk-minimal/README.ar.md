...
و أخرى مع مرفق profile واحد مثال، هو موحد واحد تركيب [MCP مورد](../../mcp/mcp-resources/README.ar.md) مرة. فقط يحتاج إعداد [MCP عميل بند](../../mcp/mcp-client/README.ar.md) يكفي إضافة خادم. أخرى مزود تركيب عميل أيضا يخص قد إعداد حالة. استدعاء جهة أثر مجال في لم إعداد خادم وقت،MCP لا مساهمة نص التوجيه نص أو أداة، افتراضي ما زال فقط لديه واحد shell أداة.
...
- [Python SDK عرض مثال](../../../python/sdk/examples/README.ar.md)——من Python بدء هذا profile، و استخدام واضح إشارة تحديد Harness home.
- [SDK تطبيق bundle](../sdk-app/README.ar.md)——كامل و أقصى بسيط SDK profile إعادة استخدام JSON-RPC تطبيق طبقة.
- [Base bundle](../base/README.ar.md)——هذا profile لحظة معنى حذف كامل منتج أساس أساس.
