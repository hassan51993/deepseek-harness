...
توليد[إعداد دليل](../../../docs/config-catalog.ar.md#deepseek-aidsh-hooks-claude-code) هو كل تلقي دعم حمل حقل نفاد كل صيغة حق مصدر.
...
- [hook بروتوكول مكتبة](../hook-protocol/README.ar.md)——هذا جسر وصل تطبيق مشترك خطاف قاعدة.
...
- [توليد إعداد دليل](../../../docs/config-catalog.ar.md#deepseek-aidsh-hooks-claude-code)——كل تلقي دعم حمل إعداد حقل و ذلك مصدر إعلان.
