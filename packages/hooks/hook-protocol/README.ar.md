...
- **حمل رسالة منع سد عملية**——خروج رمز لـ 2 خطاف سوف إيقاف نص التوجيه أو استدعاء الأداة، ذلك خطأ إخراج سوف بصفة سبب عرض.
...
| ملف | مسؤولية |
|---|---|
| [`src/index.ts`](src/index.ts) | كل أصل لغة و حدث مساعد مساعدة دالة عام تصدير |
