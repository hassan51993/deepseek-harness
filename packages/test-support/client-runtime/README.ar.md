...
- [ui-session](../../client/ui-session/README.ar.md)——من تحكم جهاز بديل ذات إرسال توليد معيار Slot بيانات مصدر إنتاج مهايئ.
- [UI slots حزمة](../../client/ui-slots/README.ar.md)——اختبار منصة تركيب `SlotRegistry` اتفاق.
- [UI renderer حزمة](../../client/ui-renderer/README.ar.md)——اختبار منصة تثبيت مصير.
- [اختبار سياسة](../../../docs/testing.ar.md)——تغطية طبقة درجة و متصفح لقطة خط الإنتاج.
