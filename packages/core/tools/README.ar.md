...
توليد[إعداد دليل](../../../docs/config-catalog.ar.md#deepseek-aidsh-tools) هو كل تلقي دعم حمل حقل نفاد كل صيغة حق مصدر. غير أصلي نمط اشتراط قد تركيب `ctx.ptcRuntime` كما ذلك لغة لديه قد تسجيل SDK مصير؛agent preset عبر [`dsh-agent-tool-presentation`](../agent-tool-presentation/README.ar.md) ذاتي سطر اختيار عرض طريقة، مفرد عدد agent متاح `presentAs(mode)` حجب حجب قيمة افتراضية.
...
- [أداة فرعي نظام](../../../docs/subsystems/tools.ar.md)——كامل خط الإنتاج نوع،schema DSL و توليد خدمة API.
- [توليد أداة دليل](../../../docs/tool-catalog.ar.md#deepseek-aidsh-tools)——نموذج استلام إلى قد تسليم أداة schema.
- [أداة تنفيذ خط الإنتاج](../../../docs/tool-execution-pipeline.ar.md)——يمكن نظر تحويل خط الإنتاج.
- [إضافة أداة فعلي تشغيل يد سجل](../../../docs/cookbook/adding-a-tool.ar.md)——قسم خطوة أداة تحرير كتابة إشارة جنوب.
- [تنسيق عمل صيغة إلغاء Agent Note](../../../.agents/notes/implemented/architecture/2026-07-19-cooperative-tool-cancellation.ar.md)——كامل إلغاء اتفاق.
...
في عادي نمط تحت، نموذج سوف يرى كل مرئي تعريف تأكيد قطع اسم، وصف و JSON Schema؛ قد تسليم تعريف سجل في توليد[أداة دليل](../../../docs/tool-catalog.ar.md#deepseek-aidsh-tools) في.agent أثر مجال حد، حجب حجب و توسيع تسجيل سوف تغيير هذا agent نهائي أداة تجميع دمج.
...
- **`tools/pre-execute` متعمد لا سماح تعديل كتابة `exec.arguments`**: لا فإن سجل سجل و عرض معامل سوف و فعلي تشغيل محتوى فقد ذهاب تزامن؛ تعديل كتابة تصميم سجل في[محاكاة اقتراح Agent Note](../../../.agents/notes/proposed/feature/2026-06-30-pre-tool-input-rewrite.ar.md) في.
