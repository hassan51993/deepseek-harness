...
| [`dsh-util-values`](../../util/values/README.ar.md) | مشترك بلا ضرر JSON تحقق و قسم مغادرة صيغة لقطة |
| [`src/repair.ts`](src/repair.ts) | انهيار انهيار متروك إبقاء سجل بارد إصلاح |
| [`src/invariant.ts`](src/invariant.ts) | ثابت صيغة إعداد طقم: ترتيب رقم، جولة/خطوة إغلاق دمج، استدعاء الأداة/نتيجة إعداد مقابل |
...
- [جلسة فرعي نظام](../../../docs/subsystems/session.ar.md)——كامل حدث مفردات،surface نوع و توليد خدمة API.
- [حفظ دائم فرعي نظام](../../../docs/subsystems/persistence.ar.md)——خلفية مثل أي يجعل هذا سجل حفظ دائم.
- [Core فرعي نظام](../../../docs/subsystems/core.ar.md)——كتابة و إرسال توليد جلسة حلقة.
- [توليد حفظ دائم دليل](../../../docs/persistence-catalog.ar.md)——كل جلسة حدث و ذلك تحميل حمل و إعلان موضع.
