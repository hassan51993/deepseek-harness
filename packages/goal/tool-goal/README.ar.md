...
هذا قيمة يجب هو صحيح أمان كامل عدد. هو حيث توفير نموذج ذاتي سطر تقرير إبلاغ منع سد صلب تحت حد، أيضا قرار نموذج إشارة جذب في إشارة واضح عدد قيمة. توليد[إعداد دليل](../../../docs/config-catalog.ar.md#deepseek-aidsh-tool-goal) هو كل تلقي دعم حمل حقل نفاد كل صيغة حق مصدر.
...
- [goal خدمة](../goal/README.ar.md)——أداة تغيير goal حالة و دورة الحياة.
- [goal مجموعة أرض رسم](../README.ar.md)——goal كل حزمة و ذلك تركيب طريقة.
- [توليد أداة دليل](../../../docs/tool-catalog.ar.md#deepseek-aidsh-tool-goal)——نموذج استقبال دقيق schema.
- [goal أداة Agent Note](../../../.agents/notes/implemented/feature/2026-07-19-model-facing-goal-tools.ar.md)——إذن تفكيك قسم و UX قرار.
...
توليد [`get_goal`،`create_goal` و `update_goal` schema](../../../docs/tool-catalog.ar.md#deepseek-aidsh-tool-goal). نجاح نتيجة هو ضيق تجميع JSON. تغيير سوف إلحاق goal مجال حمل دائم `goal/change` حدث، بينما لن سوف نموذج سياق إضافة دخول طابور صف. نتيجة في `activation` هو فوري مراقبة قيمة، أبدا سوف يصبح إعادة تشغيل إذن اعتماد حسب.
