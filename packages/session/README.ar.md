...
| [`session-checkpoint-policy/`](session-checkpoint-policy/README.ar.md) | يجعل نموذج طلب، قمة طبقة أداة فرعي أثر و قد إتمام خطوة في تحت واحد خطوة حركة عمل قبل حفظ دائم | حزمة تركيب `ctx.llm` و `ctx.tools` |
