...
| ملف | مسؤولية |
|---|---|
| [`src/chain.ts`](src/chain.ts) | متبادل مجاور خطة بنية صنع و حالي صيغة التفاف مرور |
...
| [`src/filename.ts`](src/filename.ts) | حفظ دائم، تصدير و fixture(اختبار قبل وضع بيانات) مشترك استخدام مواصفة `session[.vN].jsonl` ملف اسم |
