...
إنشاء صنع نمط يتضمن هذا مجموعة أداة. أخرى تركيب حاجة معا تركيب `@deepseek-ai/dsh-tool-cordis` و توفير `cordisInspect` host runner. استدعاء `cordis_inspect_list` اكتشاف provider، مجددا استخدام `cordis_inspect_query` استعلام ذلك أداة جسم طريقة و نوع. عبر [Plugin Manager](../../boot/plugin-manager/README.ar.md) تثبيت يتضمن إضافة شفرة أو MCP إعداد تركيب حزمة.
...
- [Plugin Manager](../../boot/plugin-manager/README.ar.md) — حفظ دائم تركيب حزمة تثبيت و بدء توقف.
- [Cordis host runner](../cordis-host-runner/README.ar.md) — فحص سجل التسجيل و قائم وقت التشغيل إزالة استهلاك من.
