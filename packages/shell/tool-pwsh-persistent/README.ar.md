...
توليد[إعداد دليل](../../../docs/config-catalog.ar.md#deepseek-aidsh-tool-pwsh-persistent) هو كل تلقي دعم حمل حقل و ذلك JSDoc نفاد كل صيغة حق مصدر.
...
- [terminal-bash خلفية](../../terminal/terminal-bash/README.ar.md)——افتراضي خلفية، إعداد `shellDialect: pwsh`.
...
- [توليد أداة دليل](../../../docs/tool-catalog.ar.md#deepseek-aidsh-tool-pwsh-persistent)——`pwsh` معامل schema تأكيد قطع محتوى.
- [توليد إعداد دليل](../../../docs/config-catalog.ar.md#deepseek-aidsh-tool-pwsh-persistent)——كل تلقي دعم حمل إعداد حقل و ذلك مصدر إعلان.
...
توليد [`pwsh` schema](../../../docs/tool-catalog.ar.md#deepseek-aidsh-tool-pwsh-persistent) ، يشمل إعداد `description`. هذا إضافة لا مساهمة مستقل توجيه النظام منطقة مقطع؛ شخص ضبط و بيئة إشارة جذب من نشر جهة مسؤول.
