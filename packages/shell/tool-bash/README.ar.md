...
- **`bash` أداة لا مشاركة و `timeout-policy` ميزانية**——هو إبقاء منفذ ذاتي لديه `BASH_TIMEOUT` مسار، رؤية[أداة استدعاء مهلة سياسة Agent Note](../../../.agents/notes/implemented/architecture/2026-07-07-tool-call-timeout-policy.ar.md).
