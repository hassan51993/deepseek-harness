...
متصفح تحميل جسم قبول [Connection](../../client/connection/README.ar.md#use-this-package) تعريف shell الذي يملك تدفق origin؛ منطق تدفق لقطة و دورة الحياة إبقاء متسق.
...
- `websocketHeartbeatIntervalMs` معا هو Ping دورة مدة و Pong قطع توقف وقت. مقابل طرف لم في تحت واحد دورة مدة قبل عودة تكرار وقت،Host سوف إنهاء اتصال؛ إذا نشر حدث حلقة أو شبكة ممكن توقف توقف تجاوز مرور هذا بين فصل، يجب ضبط كبير هذا إعداد.
