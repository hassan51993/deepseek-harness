...
|---|---|---|
| [`attachment/`](attachment/README.ar.md) | متاح في نص التوجيه و أمر، سوف حمل دائم حفظ و عودة إلى تاريخ في صورة مرفق عنصر | `ctx.attachments` |
| [`attachment-local/`](attachment-local/README.ar.md) | يأخذ مرفق إضافة صورة تخزين في هذا آلة `DSH_HOME` تحت | تسجيل إلى `ctx.attachments` |
...
- [توليد إعداد دليل](../../docs/config-catalog.ar.md#deepseek-aidsh-attachment-local)——محلي خلفية كل تلقي دعم حمل حقل.
