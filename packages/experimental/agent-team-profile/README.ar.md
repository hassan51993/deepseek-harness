...
- [Agent Teams service](../agent-team/README.ar.md)——حمل دائم roster، رسالة و مهمة لوح سلوك.
- [Agent Teams أداة](../tool-agent-team/README.ar.md)——Team-scoped نموذج أداة جدول طبقة.
- [Base bundle](../../bundle/base/README.ar.md)——هذا patch توسيع profile طبقة.
...
- **Workflow فرعي بديل إدارة أداة**——[Team أداة مرئي صفة حد](../tool-agent-team/README.ar.md#known-limitations-and-deferred-work) أيضا ملائم لأجل workflow فرعي بديل إدارة.
