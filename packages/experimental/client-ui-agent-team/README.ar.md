...
في مستقر Web bundle و Host-side Agent Teams profile بعد، عبر [`@deepseek-ai/dsh-experimental-agent-team-web-profile`](../agent-team-web-profile/README.ar.md) تثبيت هذه الحزمة.Web Client loader تركيب `/client` export؛root Host export لا تنفيذ سلوك، هذه الحزمة أيضا لا يوجد مستخدم إعداد حقل.
...
Client export تركيب قدوم ذاتي [`@deepseek-ai/dsh-experimental-agent-team/remote`](../agent-team/README.ar.md) توليد `ctx.remote.agentTeams` contribution، لكن بعد عبر Cordis effect تسجيل locale dictionary و واحد conversation-header slot.Dispose plugin fiber سوف إزالة هذا اثنان بند registration.
...
- [Agent Teams Web profile](../agent-team-web-profile/README.ar.md)——تركيب هذا Client plugin عام opt-in bundle.
- [Agent Teams service](../agent-team/README.ar.md)——مرجعي roster،task و Remote سلوك.
- [جلسة UI](../../client/ui-conversation/README.ar.md)——مستقر header slot و addressed-subagent تنقل جدول طبقة.
