...
| [`auto-review`](auto-review/README.ar.md) | صريح Web طبقة، في كل أصلي أو PTC inner استدعاء الأداة قبل استخدام نفس نموذج مراجعة فحص | — |
...
| [`inspector`](inspector/README.ar.md) | لأجل Host ضبط تجربة،Client Runtime فحص، شبكة أخذ تجميع و Cordis شجرة عبر realm CDP hub | `ctx.inspector` |
