...
- [متصفح استخدام تسجيل](../../browser-use/browser-use/README.zh.md)——اختيار واحد Provider.
- [MCP نتيجة معالجة](../../mcp/mcp-client/README.zh.md)——حمل دائم قطع رسم وصل قبول.
...
- **إلغاء**——أصلي دفع إدارة لا قبول abort signal.SDK إغلاق سوف انتظار نشط حركة عمل؛ تنظيف نجاح بعد، تحت مرة أداة استدعاء يمكن إعادة اتصال و إبقاء متصفح. إلغاء لا سحب إلغاء متصفح إدخال، أيضا لا حفظ إثبات أصلي نموذج طلب إيقاف.
