...
يتم رفض استدعاء استخدام عادي أداة بطاقة. طي سطر معرف Auto review؛ توسيع إخراج شرح body لم تنفيذ، و عرض اختياري إدارة من.[Web إذن حزمة](../../client/ui-permission-presets/README.zh.md) يملك اختيار جهاز تفاعل،[أداة UI](../../client/ui-tool/README.zh.md) يملك إدارة من عرض.
...
- [فعلي تحقق حزمة](../README.zh.md)——إصدار سياسة و اعتماد عزل.
- [Web bundle](../../bundle/web-app/README.zh.md)——هذا patch توسيع مستقر profile.
- [Auto review قرار](../../../.agents/notes/implemented/feature/2026-08-28-auto-review.zh.md)——ثابت ريح خطر سياسة، مرجعي و دورة الحياة.
- [Tools](../../core/tools/README.zh.md)——تنفيذ، إلغاء و PTC نتيجة نقل بث.
...
- reviewer في حمل سطر درجة إعفاء تجنب حال حال تحت، عبر قد ملغى ترك تزامن `snapshotEvents()` قراءة Session حركة عمل تاريخ. هذا قبل استدعاء،PTC start و مباشر أب درجة ابتدائي prompt هدف قبل كل لا يوجد إسقاط أو قسم صفحة قراءة جهة، لذلك ترحيل حسب[تزامن قراءة قرار](../../../.agents/notes/implemented/architecture/2026-09-09-deprecate-synchronous-session-event-reads.zh.md) متابعة تأجيل.
