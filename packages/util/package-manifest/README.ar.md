...
حزمة أصل فقط إعادة تصدير [`src/types.ts`](src/types.ts) في إعلان. هذه الحزمة لا إصدار وقت التشغيل ثابت كمية مرافق مع وحدة، لأن هو لا يوجد وقت التشغيل حالة أو يمكن مستقل مراقبة علاقة.
...
بلا، لأن هذه الحزمة فقط تصدير نوع.
