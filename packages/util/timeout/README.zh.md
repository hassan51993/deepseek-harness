...
- [مهلة deadline مكتبة Agent Note](../../../.agents/notes/implemented/architecture/2026-07-06-timeout-deadline-library.zh.md)——مشترك وقت ترتيب، محلي قوي صنع إنهاء حد.
- [أداة استدعاء مهلة سياسة](../../guard/timeout-policy/README.zh.md)——قوي صنع تنفيذ قد إعلان أداة مهلة مستهلك.
- [bash مزود](../../shell/bash-local/README.zh.md)——قتل ميت عملية مجموعة قبل منصة deadline مستهلك.
- [نظام الملفات فرعي نظام](../../../docs/subsystems/filesystem.zh.md)——محلي ملف IO لـ أي لا ضبط وقت حد.
