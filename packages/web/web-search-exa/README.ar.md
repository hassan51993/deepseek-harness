...
- [توليد إعداد دليل](../../../docs/config-catalog.ar.md#deepseek-aidsh-web-search-exa)——كل تلقي دعم حمل إعداد حقل و ذلك مصدر إعلان.
...
- **فقط عام `searchType`/`numResults`/`highlightsPerResult`**——Exa أخرى تحكم بند (livecrawl،category، مجال اسم/يوم مدة مرور ترشيح شرط، كل نص محتوى) انتظار مزود غير متصل خدمة حقل (رؤية [seam Agent Note](../../../.agents/notes/implemented/architecture/2026-06-24-web-capability-seam.ar.md)).
