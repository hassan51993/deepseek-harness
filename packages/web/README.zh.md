...
|---|---|---|
| [`web/`](web/README.zh.md) | بحث و إمساك أخذ خدمة: عبر يمكن متبادل تبديل خلفية بحث و إمساك أخذ URL، موحد واحد اختيار و خطأ سياسة | `ctx.web` |
| [`web-search-exa/`](web-search-exa/README.zh.md) | عبر Exa بحث web | تسجيل إلى `ctx.web` |
| [`web-search-perplexity/`](web-search-perplexity/README.zh.md) | عبر Perplexity بحث web | تسجيل إلى `ctx.web` |
| [`web-search-deepseek/`](web-search-deepseek/README.zh.md) | عبر DeepSeek أصلي بحث بحث web | تسجيل إلى `ctx.web` |
| [`web-fetch-http/`](web-fetch-http/README.zh.md) | مجهول اسم إمساك أخذ عام مشترك HTTP(S) صفحة | تسجيل إلى `ctx.web` |
| [`tool-web/`](tool-web/README.zh.md) | نحو نموذج عام `web_search` و `web_fetch` | تسجيل إلى `ctx.tools` |
...
- [web فرعي نظام](../../docs/subsystems/web.zh.md)——بحث و إمساك أخذ طلب و نتيجة، مزود متاح صفة،`WebError` و عام عنوان قوي صنع قاعدة.
