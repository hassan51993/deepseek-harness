...
|---|---|---|
| [`settings/`](settings/README.ar.md) | ضبط خدمة: تسجيل namespace و قراءة أو تعديل ذلك قيمة | `ctx.settings` |
| [`settings-file/`](settings-file/README.ar.md) | يأخذ ضبط تخزين دخول واحد محلي YAML/JSON ملف و فوري إصدار خارجي تعديل | تسجيل `ctx.settings` |
...
- [ضبط فرعي نظام مشاركة اعتبار](../../docs/subsystems/settings.ar.md)——namespace، قسم طبقة تحليل،descriptor، تغيير إيداع و توليد Cordis واجهة.
